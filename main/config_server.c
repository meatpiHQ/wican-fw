...
//backup
//char webpage[] = {"<!DOCTYPE html><html> <head> <meta name=\"viewport\" content=\"width=device-width, initial-scale=1\"> <title>Wi-CAN</title> <style> body { font-family: Arial; } .tab { overflow: hidden; border: 1px solid #ccc; background-color: #f1f1f1; width: 100%; } .tab button { background-color: inherit; float: left; border: none; outline: none; cursor: pointer; padding: 14px 16px; transition: 0.3s; font-size: 17px; } .tab button:hover { background-color: #ddd; } .tab button.active { background-color: #ccc; } .tabcontent { display: none; padding: 6px 12px; border: 1px solid #ccc; border-top: none; } table, th, td { border-collapse: collapse; border-spacing: 0; width: 350px; text-align: left; padding: 8px; } </style> </head> <body onload=\"Load()\"> <h2>Wi-CAN</h2> <div class=\"tab\"> <button class=\"tablinks\" onclick=\"openTab(event, 'status_view')\" id=\"defaultOpen\">Status</button> <button class=\"tablinks\" onclick=\"openTab(event, 'wifi_settings')\">WiFI settings</button> <button class=\"tablinks\" onclick=\"openTab(event, 'can_settings')\">CAN Settings</button> </div> <div id=\"status_view\" class=\"tabcontent\"> <table> <tr> <td>WiFi Mode:</td> <td> <div id=\"wifi_mode_current\"> AP&nbsp; </div> </td> </tr> <tr> <td> <label for=\"ap_channel_status\">AP Channel:</label> </td> <td> <div id=\"ap_channel_status\"> 6&nbsp; </div> </td> </tr> <tr> <td>WiFi Station:</td> <td> <div id=\"sta_status\"> Not Connected&nbsp; </div> </td> </tr> <tr> <td>BLE:</td> <td> <div id=\"ble_status\"> Disabled&nbsp; </div> </td> </tr> <tr> <td>Station IP:</td> <td> <div id=\"sta_ip\"> 192.168.3.1&nbsp; </div> </td> </tr> <tr> <td>CAN Bitrate:</td> <td> <div id=\"can_bitrate_status\"> 500K&nbsp; </div> </td> </tr> <tr> <td>CAN Mode:</td> <td> <div id=\"can_mode_status\"> Silent&nbsp; </div> </td> </tr> <tr> <td>Port Type:</td> <td> <div id=\"port_type_status\"> TCP&nbsp; </div> </td> </tr> <tr> <td>TCP/UDP Port:</td> <td> <div id=\"port_status\"> 3333&nbsp; </div> </td> </tr> <tr> <td> <input id=\"check_status_button\" name=\"check_status_button\" type=\"button\" onclick=\"checkStatus()\" value=\"Check status\"> </td> <td>&nbsp;</td> </tr> </table> </div> <form id=\"configForm\" name=\"configForm\" action=\"/action_page\" onchange=\"sta_enable();\" onfocus=\"this.selectedIndex = -1;\"> <div id=\"wifi_settings\" class=\"tabcontent\"> <p> <table> <tr> <td> <label for=\"wifi_mode\">Mode:</label> </td> <td> <select name=\"wifi_mode\" style=\"width: 93px\" id=\"wifi_mode\"> <option value=\"AP\">Ap</option> <option value=\"APStation\">AP+Station</option> </select> </td> </tr> <tr> <td>AP Channel:</td> <td> <select name=\"ap_ch_value\" style=\"width: 93px\" id=\"ap_ch_value\" onchange=\"submit_enable();\"> <option value=\"1\">1</option> <option value=\"2\">2</option> <option value=\"3\">3</option> <option value=\"4\">4</option> <option value=\"5\">5</option> <option value=\"6\">6</option><option value=\"7\">7</option><option value=\"8\">8</option><option value=\"9\">9</option><option value=\"10\">10</option><option value=\"11\">11</option><option value=\"12\">12</option><option value=\"13\">13</option><option value=\"14\">14</option> </select> </td> </tr> <tr> <td>&nbsp;</td> <td>&nbsp;</td> </tr> <tr> <td> <b>Station Config:</b> </td> <td>&nbsp;</td> </tr> <tr> <td> <label for=\"ssid_value\">SSID:</label> </td> <td> <input type=\"text\" id=\"ssid_value\" name=\"ssid_value\" value=\"Testssid\" disabled> </td> </tr> <tr> <td> <label for=\"pass_value\">Password:</label> </td> <td> <input type=\"text\" id=\"pass_value\" name=\"pass_value\" value=\"Testpass\" disabled> </td> </tr> </table> </p> </div> <div id=\"can_settings\" class=\"tabcontent\"> <p> <table> <tr> <td> <label for=\"can_datarate\">CAN Bitrate:</label> </td> <td> <select name=\"can_datarate\" style=\"width: 93px\" id=\"can_datarate\" onchange=\"submit_enable();\" > <option value=\"25K\">25K</option> <option value=\"50K\">50K</option> <option value=\"100K\">100K</option> <option value=\"125K\">125K</option> <option value=\"250K\">250K</option><option value=\"500K\">500K</option> <option value=\"800K\">800K</option><option value=\"1000K\">1000K</option> </select> </td> </tr> <tr> <td> <label for=\"can_mode\">CAN Mode:</label> </td> <td> <select name=\"can_mode\" style=\"width: 93px\" id=\"can_mode\" onchange=\"submit_enable();\"> <option value=\"normal\" selected=\"selected\">Normal</option> <option value=\"silent\">Silent</option> </select> </td> </tr> <tr> <td> <label for=\"port_type\">Port Type:</label> </td> <td> <select name=\"port_type\" style=\"width: 93px\" id=\"port_type\" onchange=\"submit_enable();\"> <option value=\"tcp\">TCP</option> <option value=\"udp\">UDP</option> </select> </td> </tr> <tr> <td> <label for=\"tcp_port_value\">TCP/UDP Port:</label> </td> <td> <input type=\"number\" onchange=\"tcpPortCheck();\" id=\"tcp_port_value\" name=\"tcp_port_value\" value=\"3333\" min=\"1\" max=\"65535\"> </td> </tr> <tr> <td> <div id=\"tcp_txt\"> &nbsp; </div> </td> <td>&nbsp;</td> </tr> </table> </p> </div> <div id=\"ret_msg\"> &nbsp; </div> </form> <input id=\"submit_button\" name=\"submit_button\" type=\"button\" onclick=\"postConfig()\" value=\"Submit Changes\" disabled> <script> function openTab(evt, tabName) { var i, tabcontent, tablinks; tabcontent = document.getElementsByClassName(\"tabcontent\"); for (i = 0; i < tabcontent.length; i++) { tabcontent[i].style.display = \"none\"; } tablinks = document.getElementsByClassName(\"tablinks\"); for (i = 0; i < tablinks.length; i++) { tablinks[i].className = tablinks[i].className.replace(\" active\", \"\"); } document.getElementById(tabName).style.display = \"block\"; evt.currentTarget.className += \" active\"; } function sta_enable() { if (document.getElementById(\"wifi_mode\").value == \"AP\") { document.getElementById(\"ssid_value\").disabled = true; document.getElementById(\"pass_value\").disabled = true; document.getElementById(\"submit_button\").disabled = false; } else { document.getElementById(\"ssid_value\").disabled = false; document.getElementById(\"pass_value\").disabled = false; document.getElementById(\"submit_button\").disabled = false; } } function submit_enable() { document.getElementById(\"submit_button\").disabled = false; } document.getElementById(\"defaultOpen\").click(); function checkStatus() { const xhttp = new XMLHttpRequest(); xhttp.onload = function() { var obj = JSON.parse(this.responseText); if(obj.wifi_mode == \"APStation\") {document.getElementById(\"wifi_mode_current\").innerHTML = \"AP+Station\"; } else if(obj.wifi_mode == \"AP\") {document.getElementById(\"wifi_mode_current\").innerHTML = \"AP\"; } document.getElementById(\"sta_status\").innerHTML = obj.sta_status; document.getElementById(\"ap_channel_status\").innerHTML = obj.ap_ch; document.getElementById(\"sta_ip\").innerHTML = obj.sta_ip; document.getElementById(\"ble_status\").innerHTML = obj.ble_status; document.getElementById(\"can_bitrate_status\").innerHTML = obj.can_datarate; if(obj.can_mode == \"normal\") {document.getElementById(\"can_mode_status\").innerHTML = \"Normal\"; } else if(obj.can_mode == \"silent\") {document.getElementById(\"can_mode_status\").innerHTML = \"Silent\"; } if(obj.can_mode == \"tcp\") {document.getElementById(\"port_type_status\").innerHTML = \"TCP\"; } else if(obj.can_mode == \"udp\") {document.getElementById(\"port_type_status\").innerHTML = \"UDP\"; } document.getElementById(\"port_status\").innerHTML = obj.port; }; xhttp.open(\"GET\", \"/check_status\"); xhttp.send(); } function postConfig() {var obj = {};obj[\"wifi_mode\"] = document.getElementById(\"wifi_mode\").value;obj[\"ap_ch\"] = document.getElementById(\"ap_ch_value\").value;obj[\"sta_ssid\"] = document.getElementById(\"ssid_value\").value;obj[\"sta_pass\"] = document.getElementById(\"pass_value\").value;obj[\"can_datarate\"] = document.getElementById(\"can_datarate\").value;obj[\"can_mode\"] = document.getElementById(\"can_mode\").value;obj[\"port_type\"] = document.getElementById(\"port_type\").value;obj[\"port\"] = document.getElementById(\"tcp_port_value\").value;var configJSON = JSON.stringify(obj); const xhttp = new XMLHttpRequest(); xhttp.onload = function() { document.getElementById(\"ret_msg\").innerHTML = this.responseText; document.getElementById(\"ret_msg\").style.color = \"red\"; };xhttp.open(\"POST\", \"/store_config\"); xhttp.send(configJSON); } function Load() { const xhttp = new XMLHttpRequest(); xhttp.onload = function() { var obj = JSON.parse(this.responseText); if(obj.wifi_mode == \"APStation\") {document.getElementById(\"wifi_mode\").selectedIndex = \"1\";document.getElementById(\"ssid_value\").disabled = false;document.getElementById(\"pass_value\").disabled = false; } else if(obj.wifi_mode == \"AP\") {document.getElementById(\"wifi_mode\").selectedIndex = \"0\";document.getElementById(\"ssid_value\").disabled = true;document.getElementById(\"pass_value\").disabled = true; } var ch = parseInt(obj.ap_ch); ch = ch - 1; document.getElementById(\"ap_ch_value\").selectedIndex = ch.toString(); document.getElementById(\"ssid_value\").value = obj.sta_ssid; document.getElementById(\"pass_value\").value = obj.sta_pass; if(obj.can_datarate == \"25K\") {document.getElementById(\"can_datarate\").selectedIndex = \"0\"; } else if(obj.can_datarate == \"50K\") {document.getElementById(\"can_datarate\").selectedIndex = \"1\"; } else if(obj.can_datarate == \"100K\") {document.getElementById(\"can_datarate\").selectedIndex = \"2\"; } else if(obj.can_datarate == \"125K\") {document.getElementById(\"can_datarate\").selectedIndex = \"3\"; } else if(obj.can_datarate == \"250K\") {document.getElementById(\"can_datarate\").selectedIndex = \"4\"; } else if(obj.can_datarate == \"500K\") {document.getElementById(\"can_datarate\").selectedIndex = \"5\"; } else if(obj.can_datarate == \"800K\") {document.getElementById(\"can_datarate\").selectedIndex = \"6\"; } else if(obj.can_datarate == \"1000K\") {document.getElementById(\"can_datarate\").selectedIndex = \"7\"; } if(obj.can_mode == \"normal\") {document.getElementById(\"can_mode\").selectedIndex = \"0\"; } else if(obj.can_mode == \"silent\") {document.getElementById(\"can_mode\").selectedIndex = \"1\"; } if(obj.port_type == \"tcp\") {document.getElementById(\"port_type\").selectedIndex = \"0\"; } else if(obj.port_type == \"udp\") {document.getElementById(\"port_type\").selectedIndex = \"1\"; } document.getElementById(\"tcp_port_value\").value = obj.port; };checkStatus(); xhttp.open(\"GET\", \"/load_config\"); xhttp.send(); } function tcpPortCheck() { if (document.getElementById(\"tcp_port_value\").value > 65535) { document.getElementById(\"tcp_txt\").innerHTML = \"Port should be less than 65535\"; } if (document.getElementById(\"tcp_port_value\").value <= 65535) { document.getElementById(\"tcp_txt\").innerHTML = \"&nbsp;\"; } } </script> </body></html>"};

//static const char webpage[] = {"<!DOCTYPE html><html> <head> <meta name=\"viewport\" content=\"width=device-width, initial-scale=1\" > <title>Wi-CAN</title> <style> body { font-family: Arial; } .tab { overflow: hidden; border: 1px solid #24478f; background-color: #c2d1f0; width: 100%; } .tab button { background-color: inherit; float: left; border: none; outline: none; cursor: pointer; padding: 14px 16px; transition: 0.3s; font-size: 17px; } .tab button:hover { background-color: #ddd; } .tab button.active { background-color: #24478f; color: white; } .tabcontent { display: none; padding: 6px 12px; border: 1px solid #24478f; border-top: none; } table, th, td { border-collapse: collapse; border-spacing: 0; width: 350px; text-align: left; padding: 8px; } </style> </head> <body onload=\"Load()\"> <embed src=\"/logo.svg\" style=\"width:165px;height:66px;display: block;\"/> <div class=\"tab\"> <button class=\"tablinks\" onclick=\"openTab(event, 'status_view')\" id=\"defaultOpen\"> <b>Status</b> </button> <button class=\"tablinks\" onclick=\"openTab(event, 'wifi_settings')\"> <b>WiFI</b> </button> <button class=\"tablinks\" onclick=\"openTab(event, 'can_settings')\"> <b>CAN</b> </button> <button class=\"tablinks\" onclick=\"openTab(event, 'about_tab')\"> <b>About</b> </button> </div> <div id=\"status_view\" class=\"tabcontent\"> <table> <tr> <td> <b>WiFi Mode:</b> </td> <td> <div id=\"wifi_mode_current\"> AP&nbsp; </div> </td> </tr> <tr> <td> <b>AP Channel:</b> </td> <td> <div id=\"ap_channel_status\"> 6&nbsp; </div> </td> </tr> <tr> <td> <b>WiFi Station:</b> </td> <td> <div id=\"sta_status\"> Not Connected&nbsp; </div> </td> </tr> <tr> <td> <b>BLE:</b> </td> <td> <div id=\"ble_status\"> Disabled&nbsp; </div> </td> </tr> <tr> <td> <b>Station IP:</b> </td> <td> <div id=\"sta_ip\"> 192.168.3.1&nbsp; </div> </td> </tr> <tr> <td> <b>CAN Bitrate:</b> </td> <td> <div id=\"can_bitrate_status\"> 500K&nbsp; </div> </td> </tr> <tr> <td> <b>CAN Mode:</b> </td> <td> <div id=\"can_mode_status\"> Silent&nbsp; </div> </td> </tr> <tr> <td> <b>Port Type:</b> </td> <td> <div id=\"port_type_status\"> TCP&nbsp; </div> </td> </tr> <tr> <td> <b>TCP/UDP Port:</b> </td> <td> <div id=\"port_status\"> 3333&nbsp; </div> </td> </tr> <tr> <td> <input id=\"check_status_button\" name=\"check_status_button\" type=\"button\" onclick=\"checkStatus()\" value=\"Check status\"> </td> <td>&nbsp;</td> </tr> </table> </div> <form id=\"configForm\" name=\"configForm\" action=\"/action_page\" onchange=\"submit_enable();\" onfocus=\"this.selectedIndex = -1;\"> <div id=\"wifi_settings\" class=\"tabcontent\"> <table> <tr> <td> <label for=\"wifi_mode\"> <b>Mode:</b> </label> </td> <td> <select name=\"wifi_mode\" style=\"width: 93px\" id=\"wifi_mode\"> <option value=\"AP\">Ap</option> <option value=\"APStation\">AP+Station</option> </select> </td> </tr> <tr> <td> <b>AP Channel:</b> </td> <td> <select name=\"ap_ch_value\" style=\"width: 93px\" id=\"ap_ch_value\" \"> <option value=\"1\">1</option> <option value=\"2\">2</option> <option value=\"3\">3</option> <option value=\"4\">4</option> <option value=\"5\">5</option> <option value=\"6\">6</option> <option value=\"7\">7</option> <option value=\"8\">8</option> <option value=\"9\">9</option> <option value=\"10\">10</option> <option value=\"11\">11</option> <option value=\"12\">12</option> <option value=\"13\">13</option> <option value=\"14\">14</option> </select> </td> </tr> <tr> <td> <b> <u>Station Config:</u> </b> </td> <td>&nbsp;</td> </tr> <tr> <td> <label for=\"ssid_value\"> <b>SSID:</b> </label> </td> <td> <input type=\"text\" id=\"ssid_value\" name=\"ssid_value\" value=\"MeatPi\" disabled> </td> </tr> <tr> <td> <label for=\"pass_value\"> <b>Password:</b> </label> </td> <td> <input type=\"text\" id=\"pass_value\" name=\"pass_value\" value=\"TomatoSauce\" disabled> </td> </tr> <tr> <td> <b> <u>AP Config:</u> </b> </td> <td>&nbsp;</td> </tr> <tr> <td> <label for=\"ap_pass_value\"> <b>AP Password:</b> </label> </td> <td> <input type=\"text\" id=\"ap_pass_value\" name=\"ap_pass_value\" value=\"Testpass\" \"> </td> </tr> </table><div id=\"note\"><u><b>Note:</b> If you forget the AP password, connect usb cable to recover</u></div> </div> <div id=\"can_settings\" class=\"tabcontent\"> <table> <tr> <td> <label for=\"can_datarate\"> <b>CAN Bitrate:</b> </label> </td> <td> <select name=\"can_datarate\" style=\"width: 93px\" id=\"can_datarate\" \"><option value=\"5K\">5K</option><option value=\"10K\">10K</option><option value=\"20K\">20K</option> <option value=\"25K\">25K</option> <option value=\"50K\">50K</option> <option value=\"100K\">100K</option> <option value=\"125K\">125K</option> <option value=\"250K\">250K</option> <option value=\"500K\">500K</option> <option value=\"800K\">800K</option> <option value=\"1000K\">1000K</option> </select> </td> </tr> <tr> <td> <label for=\"can_mode\"> <b>CAN Mode:</b> </label> </td> <td> <select name=\"can_mode\" style=\"width: 93px\" id=\"can_mode\" \"> <option value=\"normal\" selected=\"selected\">Normal</option> <option value=\"silent\">Silent</option> </select> </td> </tr> <tr> <td> <label for=\"port_type\"> <b>Port Type:</b> </label> </td> <td> <select name=\"port_type\" style=\"width: 93px\" id=\"port_type\" \"> <option value=\"tcp\">TCP</option> <option value=\"udp\">UDP</option> </select> </td> </tr> <tr> <td> <label for=\"tcp_port_value\"> <b>TCP/UDP Port:</b> </label> </td> <td> <input type=\"number\" id=\"tcp_port_value\" name=\"tcp_port_value\" value=\"3333\" min=\"1\" max=\"65535\"> </td> </tr> <tr> <td> <label for=\"protocol\"> <b>Protocol:</b> </label> </td> <td> <select name=\"protocol\" style=\"width: 93px\" id=\"protocol\" \"> <option value=\"realdash66\">realdash66</option> </select> </td> </tr> <tr> <td> <div id=\"tcp_txt\"> &nbsp; </div> </td> <td>&nbsp;</td> </tr> </table> </div> <div id=\"about_tab\" class=\"tabcontent\"> <table> <tr> <td> <b>Firmware ver:</b> </td> <td> <div id=\"fw_version\"> v1.00 </div> </td> </tr> <tr> <td> <b>Hardware ver:</b> </td> <td> <div id=\"hw_version\"> v2.10 </div> </td> </tr> <tr> <td> <b>Designed By:</b> </td> <td> <div id=\"made_by\"> <a href=\"https://www.meatpi.com/\"> <b>meatpi.com</b> </a> </div> </td> </tr> </table> </div> <div id=\"ret_msg\"> &nbsp; </div> </form> <input id=\"submit_button\" name=\"submit_button\" type=\"button\" onclick=\"postConfig()\" value=\"Submit Changes\" disabled> <script> function openTab(evt, tabName) { var i, tabcontent, tablinks; tabcontent = document.getElementsByClassName(\"tabcontent\"); for (i = 0; i < tabcontent.length; i++) { tabcontent[i].style.display = \"none\"; } tablinks = document.getElementsByClassName(\"tablinks\"); for (i = 0; i < tablinks.length; i++) { tablinks[i].className = tablinks[i].className.replace(\" active\", \"\"); } document.getElementById(tabName).style.display = \"block\"; evt.currentTarget.className += \" active\"; } function sta_enable() { } function submit_enable() { if (document.getElementById(\"wifi_mode\").value == \"AP\") { document.getElementById(\"ssid_value\").disabled = true; document.getElementById(\"pass_value\").disabled = true; } else { document.getElementById(\"ssid_value\").disabled = false; document.getElementById(\"pass_value\").disabled = false; }if(document.getElementById(\"ap_pass_value\").value.length < 8 ||document.getElementById(\"ap_pass_value\").value.length > 63 ||document.getElementById(\"pass_value\").value.length < 8 ||document.getElementById(\"pass_value\").value.length > 63){document.getElementById(\"ret_msg\").innerHTML = \"AP/station password len, min=0 max=64\";document.getElementById(\"ret_msg\").style.color = \"red\";document.getElementById(\"submit_button\").disabled = true;}else if(document.getElementById(\"ssid_value\").value.length < 1 ||document.getElementById(\"ssid_value\").value.length > 32){document.getElementById(\"ret_msg\").innerHTML = \"AP/station ssid len, min=1 max=32\";document.getElementById(\"ret_msg\").style.color = \"red\";document.getElementById(\"submit_button\").disabled = true;}else if (document.getElementById(\"tcp_port_value\").value > 65535 ||document.getElementById(\"tcp_port_value\").value < 1) {document.getElementById(\"ret_msg\").innerHTML = \"Port value, min=1 max=65535\";document.getElementById(\"ret_msg\").style.color = \"red\";document.getElementById(\"submit_button\").disabled = true; }else{document.getElementById(\"submit_button\").disabled = false;document.getElementById(\"ret_msg\").innerHTML = \" \"} } document.getElementById(\"defaultOpen\").click(); function checkStatus() { const xhttp = new XMLHttpRequest(); xhttp.onload = function() { var obj = JSON.parse(this.responseText); if (obj.wifi_mode == \"APStation\") { document.getElementById(\"wifi_mode_current\").innerHTML = \"AP+Station\"; } else if (obj.wifi_mode == \"AP\") { document.getElementById(\"wifi_mode_current\").innerHTML = \"AP\"; } document.getElementById(\"sta_status\").innerHTML = obj.sta_status; document.getElementById(\"ap_channel_status\").innerHTML = obj.ap_ch; document.getElementById(\"sta_ip\").innerHTML = obj.sta_ip; document.getElementById(\"ble_status\").innerHTML = obj.ble_status; document.getElementById(\"can_bitrate_status\").innerHTML = obj.can_datarate; if (obj.can_mode == \"normal\") { document.getElementById(\"can_mode_status\").innerHTML = \"Normal\"; } else if (obj.can_mode == \"silent\") { document.getElementById(\"can_mode_status\").innerHTML = \"Silent\"; } if (obj.port_type == \"tcp\") { document.getElementById(\"port_type_status\").innerHTML = \"TCP\"; } else if (obj.port_type == \"udp\") { document.getElementById(\"port_type_status\").innerHTML = \"UDP\"; } document.getElementById(\"port_status\").innerHTML = obj.port; document.getElementById(\"fw_version\").value = obj.fw_version; document.getElementById(\"hw_version\").value = obj.hw_version; document.getElementById(\"ret_msg\").innerHTML = \" \"; }; xhttp.open(\"GET\", \"/check_status\"); xhttp.send(); } function postConfig() { var obj = {}; obj[\"wifi_mode\"] = document.getElementById(\"wifi_mode\").value; obj[\"ap_ch\"] = document.getElementById(\"ap_ch_value\").value; obj[\"sta_ssid\"] = document.getElementById(\"ssid_value\").value; obj[\"sta_pass\"] = document.getElementById(\"pass_value\").value; obj[\"can_datarate\"] = document.getElementById(\"can_datarate\").value; obj[\"can_mode\"] = document.getElementById(\"can_mode\").value; obj[\"port_type\"] = document.getElementById(\"port_type\").value; obj[\"port\"] = document.getElementById(\"tcp_port_value\").value;obj[\"ap_pass\"] = document.getElementById(\"ap_pass_value\").value; var configJSON = JSON.stringify(obj); const xhttp = new XMLHttpRequest(); xhttp.onload = function() { document.getElementById(\"ret_msg\").innerHTML = this.responseText; document.getElementById(\"ret_msg\").style.color = \"red\"; }; xhttp.open(\"POST\", \"/store_config\"); xhttp.send(configJSON); } function Load() { const xhttp = new XMLHttpRequest(); xhttp.onload = function() { var obj = JSON.parse(this.responseText); if (obj.wifi_mode == \"APStation\") { document.getElementById(\"wifi_mode\").selectedIndex = \"1\"; document.getElementById(\"ssid_value\").disabled = false; document.getElementById(\"pass_value\").disabled = false; } else if (obj.wifi_mode == \"AP\") { document.getElementById(\"wifi_mode\").selectedIndex = \"0\"; document.getElementById(\"ssid_value\").disabled = true; document.getElementById(\"pass_value\").disabled = true; } var ch = parseInt(obj.ap_ch); ch = ch - 1; document.getElementById(\"ap_ch_value\").selectedIndex = ch.toString(); document.getElementById(\"ssid_value\").value = obj.sta_ssid; document.getElementById(\"pass_value\").value = obj.sta_pass; if (obj.can_datarate == \"5K\") { document.getElementById(\"can_datarate\").selectedIndex = \"0\"; } else if (obj.can_datarate == \"10K\") { document.getElementById(\"can_datarate\").selectedIndex = \"1\"; } else if (obj.can_datarate == \"20K\") { document.getElementById(\"can_datarate\").selectedIndex = \"2\"; }else if (obj.can_datarate == \"25K\") { document.getElementById(\"can_datarate\").selectedIndex = \"3\"; } else if (obj.can_datarate == \"50K\") { document.getElementById(\"can_datarate\").selectedIndex = \"4\"; } else if (obj.can_datarate == \"100K\") { document.getElementById(\"can_datarate\").selectedIndex = \"5\"; } else if (obj.can_datarate == \"125K\") { document.getElementById(\"can_datarate\").selectedIndex = \"6\"; } else if (obj.can_datarate == \"250K\") { document.getElementById(\"can_datarate\").selectedIndex = \"7\"; } else if (obj.can_datarate == \"500K\") { document.getElementById(\"can_datarate\").selectedIndex = \"8\"; } else if (obj.can_datarate == \"800K\") { document.getElementById(\"can_datarate\").selectedIndex = \"9\"; } else if (obj.can_datarate == \"1000K\") { document.getElementById(\"can_datarate\").selectedIndex = \"10\"; } if (obj.can_mode == \"normal\") { document.getElementById(\"can_mode\").selectedIndex = \"0\"; } else if (obj.can_mode == \"silent\") { document.getElementById(\"can_mode\").selectedIndex = \"1\"; } if (obj.port_type == \"tcp\") { document.getElementById(\"port_type\").selectedIndex = \"0\"; } else if (obj.port_type == \"udp\") { document.getElementById(\"port_type\").selectedIndex = \"1\"; } document.getElementById(\"tcp_port_value\").value = obj.port; document.getElementById(\"ap_pass_value\").value = obj.ap_pass; document.getElementById(\"ret_msg\").innerHTML = \" \"; }; checkStatus(); xhttp.open(\"GET\", \"/load_config\"); xhttp.send(); } </script> </body></html>"};

//static const char webpage[] = {"<!DOCTYPE html><html> <head> <meta name=\"viewport\" content=\"width=device-width, initial-scale=1\" > <title>Wi-CAN</title> <style> body { font-family: Arial; } .tab { overflow: hidden; border: 1px solid #24478f; background-color: #c2d1f0; width: 100%; } .tab button { background-color: inherit; float: left; border: none; outline: none; cursor: pointer; padding: 14px 16px; transition: 0.3s; font-size: 17px; } .tab button:hover { background-color: #ddd; } .tab button.active { background-color: #24478f; color: white; } .tabcontent { display: none; padding: 6px 12px; border: 1px solid #24478f; border-top: none; } table, th, td { border-collapse: collapse; border-spacing: 0; width: 350px; text-align: left; padding: 8px; } </style> </head> <body onload=\"Load()\"> <embed src=\"/logo.svg\" style=\"width:165px;height:66px;display: block;\"/> <div class=\"tab\"> <button class=\"tablinks\" onclick=\"openTab(event, 'status_view')\" id=\"defaultOpen\"> <b>Status</b> </button> <button class=\"tablinks\" onclick=\"openTab(event, 'wifi_settings')\"> <b>WiFI</b> </button> <button class=\"tablinks\" onclick=\"openTab(event, 'can_settings')\"> <b>CAN</b> </button> <button class=\"tablinks\" onclick=\"openTab(event, 'about_tab')\"> <b>About</b> </button> </div> <div id=\"status_view\" class=\"tabcontent\"> <table> <tr> <td> <b>WiFi Mode:</b> </td> <td> <div id=\"wifi_mode_current\"> AP&nbsp; </div> </td> </tr> <tr> <td> <b>AP Channel:</b> </td> <td> <div id=\"ap_channel_status\"> 6&nbsp; </div> </td> </tr> <tr> <td> <b>WiFi Station:</b> </td> <td> <div id=\"sta_status\"> Not Connected&nbsp; </div> </td> </tr> <tr> <td> <b>BLE:</b> </td> <td> <div id=\"ble_status\"> Disabled&nbsp; </div> </td> </tr> <tr> <td> <b>Station IP:</b> </td> <td> <div id=\"sta_ip\"> 192.168.3.1&nbsp; </div> </td> </tr> <tr> <td> <b>CAN Bitrate:</b> </td> <td> <div id=\"can_bitrate_status\"> 500K&nbsp; </div> </td> </tr> <tr> <td> <b>CAN Mode:</b> </td> <td> <div id=\"can_mode_status\"> Silent&nbsp; </div> </td> </tr> <tr> <td> <b>Port Type:</b> </td> <td> <div id=\"port_type_status\"> TCP&nbsp; </div> </td> </tr> <tr> <td> <b>TCP/UDP Port:</b> </td> <td> <div id=\"port_status\"> 3333&nbsp; </div> </td> </tr> <tr> <td> <input id=\"check_status_button\" name=\"check_status_button\" type=\"button\" onclick=\"checkStatus()\" value=\"Check status\"> </td> <td>&nbsp;</td> </tr> </table> </div> <form id=\"configForm\" name=\"configForm\" action=\"/action_page\" onchange=\"submit_enable();\" onfocus=\"this.selectedIndex = -1;\"> <div id=\"wifi_settings\" class=\"tabcontent\"> <table> <tr> <td> <label for=\"wifi_mode\"> <b>Mode:</b> </label> </td> <td> <select name=\"wifi_mode\" style=\"width: 93px\" id=\"wifi_mode\"> <option value=\"AP\">Ap</option> <option value=\"APStation\">AP+Station</option> </select> </td> </tr> <tr> <td> <b>AP Channel:</b> </td> <td> <select name=\"ap_ch_value\" style=\"width: 93px\" id=\"ap_ch_value\"> <option value=\"1\">1</option> <option value=\"2\">2</option> <option value=\"3\">3</option> <option value=\"4\">4</option> <option value=\"5\">5</option> <option value=\"6\">6</option> <option value=\"7\">7</option> <option value=\"8\">8</option> <option value=\"9\">9</option> <option value=\"10\">10</option> <option value=\"11\">11</option> <option value=\"12\">12</option> <option value=\"13\">13</option> <option value=\"14\">14</option> </select> </td> </tr> <tr> <td> <b> <u>Station Config:</u> </b> </td> <td>&nbsp;</td> </tr> <tr> <td> <label for=\"ssid_value\"> <b>SSID:</b> </label> </td> <td> <input type=\"text\" id=\"ssid_value\" name=\"ssid_value\" value=\"MeatPi\" disabled> </td> </tr> <tr> <td> <label for=\"pass_value\"> <b>Password:</b> </label> </td> <td> <input type=\"text\" id=\"pass_value\" name=\"pass_value\" value=\"TomatoSauce\" disabled> </td> </tr> <tr> <td> <b> <u>AP Config:</u> </b> </td> <td>&nbsp;</td> </tr> <tr> <td> <label for=\"ap_pass_value\"> <b>AP Password:</b> </label> </td> <td> <input type=\"text\" id=\"ap_pass_value\" name=\"ap_pass_value\" value=\"Testpass\"> </td> </tr> </table><div id=\"note\"><u><b>Note:</b> If you forget the AP password, connect usb cable to recover</u></div> </div> <div id=\"can_settings\" class=\"tabcontent\"> <table> <tr> <td> <label for=\"can_datarate\"> <b>CAN Bitrate:</b> </label> </td> <td> <select name=\"can_datarate\" style=\"width: 93px\" id=\"can_datarate\"><option value=\"5K\">5K</option><option value=\"10K\">10K</option><option value=\"20K\">20K</option> <option value=\"25K\">25K</option> <option value=\"50K\">50K</option> <option value=\"100K\">100K</option> <option value=\"125K\">125K</option> <option value=\"250K\">250K</option> <option value=\"500K\">500K</option> <option value=\"800K\">800K</option> <option value=\"1000K\">1000K</option> </select> </td> </tr> <tr> <td> <label for=\"can_mode\"> <b>CAN Mode:</b> </label> </td> <td> <select name=\"can_mode\" style=\"width: 93px\" id=\"can_mode\"> <option value=\"normal\" selected=\"selected\">Normal</option> <option value=\"silent\">Silent</option> </select> </td> </tr> <tr> <td> <label for=\"port_type\"> <b>Port Type:</b> </label> </td> <td> <select name=\"port_type\" style=\"width: 93px\" id=\"port_type\"> <option value=\"tcp\">TCP</option> <option value=\"udp\">UDP</option> </select> </td> </tr> <tr> <td> <label for=\"tcp_port_value\"> <b>TCP/UDP Port:</b> </label> </td> <td> <input type=\"number\" id=\"tcp_port_value\" name=\"tcp_port_value\" value=\"3333\" min=\"1\" max=\"65535\"> </td> </tr> <tr> <td> <label for=\"protocol\"> <b>Protocol:</b> </label> </td> <td> <select name=\"protocol\" style=\"width: 93px\" id=\"protocol\"> <option value=\"realdash66\">realdash66</option><option value=\"slcan\">slcan</option> </select> </td> </tr> <tr> <td> <div id=\"tcp_txt\"> &nbsp; </div> </td> <td>&nbsp;</td> </tr> </table> </div> <div id=\"about_tab\" class=\"tabcontent\"> <table> <tr> <td> <b>Firmware ver:</b> </td> <td> <div id=\"fw_version\"> v1.00 </div> </td> </tr> <tr> <td> <b>Hardware ver:</b> </td> <td> <div id=\"hw_version\"> v2.10 </div> </td> </tr> <tr> <td> <b>Designed By:</b> </td> <td> <div id=\"made_by\"> <a href=\"https://www.meatpi.com/\"> <b>meatpi.com</b> </a> </div> </td> </tr> </table> </div> <div id=\"ret_msg\"> &nbsp; </div> </form> <input id=\"submit_button\" name=\"submit_button\" type=\"button\" onclick=\"postConfig()\" value=\"Submit Changes\" disabled> <script> function openTab(evt, tabName) { var i, tabcontent, tablinks; tabcontent = document.getElementsByClassName(\"tabcontent\"); for (i = 0; i < tabcontent.length; i++) { tabcontent[i].style.display = \"none\"; } tablinks = document.getElementsByClassName(\"tablinks\"); for (i = 0; i < tablinks.length; i++) { tablinks[i].className = tablinks[i].className.replace(\" active\", \"\"); } document.getElementById(tabName).style.display = \"block\"; evt.currentTarget.className += \" active\"; } function sta_enable() { } function submit_enable() { if (document.getElementById(\"wifi_mode\").value == \"AP\") { document.getElementById(\"ssid_value\").disabled = true; document.getElementById(\"pass_value\").disabled = true; } else { document.getElementById(\"ssid_value\").disabled = false; document.getElementById(\"pass_value\").disabled = false; }if(document.getElementById(\"ap_pass_value\").value.length < 8 ||document.getElementById(\"ap_pass_value\").value.length > 63 ||document.getElementById(\"pass_value\").value.length < 8 ||document.getElementById(\"pass_value\").value.length > 63){document.getElementById(\"ret_msg\").innerHTML = \"AP/station password len, min=0 max=64\";document.getElementById(\"ret_msg\").style.color = \"red\";document.getElementById(\"submit_button\").disabled = true;}else if(document.getElementById(\"ssid_value\").value.length < 1 ||document.getElementById(\"ssid_value\").value.length > 32){document.getElementById(\"ret_msg\").innerHTML = \"AP/station ssid len, min=1 max=32\";document.getElementById(\"ret_msg\").style.color = \"red\";document.getElementById(\"submit_button\").disabled = true;}else if (document.getElementById(\"tcp_port_value\").value > 65535 ||document.getElementById(\"tcp_port_value\").value < 1) {document.getElementById(\"ret_msg\").innerHTML = \"Port value, min=1 max=65535\";document.getElementById(\"ret_msg\").style.color = \"red\";document.getElementById(\"submit_button\").disabled = true; }else{document.getElementById(\"submit_button\").disabled = false;document.getElementById(\"ret_msg\").innerHTML = \" \"} } document.getElementById(\"defaultOpen\").click(); function checkStatus() { const xhttp = new XMLHttpRequest(); xhttp.onload = function() { var obj = JSON.parse(this.responseText); if (obj.wifi_mode == \"APStation\") { document.getElementById(\"wifi_mode_current\").innerHTML = \"AP+Station\"; } else if (obj.wifi_mode == \"AP\") { document.getElementById(\"wifi_mode_current\").innerHTML = \"AP\"; } document.getElementById(\"sta_status\").innerHTML = obj.sta_status; document.getElementById(\"ap_channel_status\").innerHTML = obj.ap_ch; document.getElementById(\"sta_ip\").innerHTML = obj.sta_ip; document.getElementById(\"ble_status\").innerHTML = obj.ble_status; document.getElementById(\"can_bitrate_status\").innerHTML = obj.can_datarate; if (obj.can_mode == \"normal\") { document.getElementById(\"can_mode_status\").innerHTML = \"Normal\"; } else if (obj.can_mode == \"silent\") { document.getElementById(\"can_mode_status\").innerHTML = \"Silent\"; } if (obj.port_type == \"tcp\") { document.getElementById(\"port_type_status\").innerHTML = \"TCP\"; } else if (obj.port_type == \"udp\") { document.getElementById(\"port_type_status\").innerHTML = \"UDP\"; } document.getElementById(\"port_status\").innerHTML = obj.port; document.getElementById(\"fw_version\").value = obj.fw_version; document.getElementById(\"hw_version\").value = obj.hw_version; document.getElementById(\"protocol\").value = obj.protocol; document.getElementById(\"ret_msg\").innerHTML = \" \"; }; xhttp.open(\"GET\", \"/check_status\"); xhttp.send(); } function postConfig() { var obj = {}; obj[\"wifi_mode\"] = document.getElementById(\"wifi_mode\").value; obj[\"ap_ch\"] = document.getElementById(\"ap_ch_value\").value; obj[\"sta_ssid\"] = document.getElementById(\"ssid_value\").value; obj[\"sta_pass\"] = document.getElementById(\"pass_value\").value; obj[\"can_datarate\"] = document.getElementById(\"can_datarate\").value; obj[\"can_mode\"] = document.getElementById(\"can_mode\").value; obj[\"port_type\"] = document.getElementById(\"port_type\").value; obj[\"port\"] = document.getElementById(\"tcp_port_value\").value;obj[\"ap_pass\"] = document.getElementById(\"ap_pass_value\").value;obj[\"protocol\"] = document.getElementById(\"protocol\").value; var configJSON = JSON.stringify(obj); const xhttp = new XMLHttpRequest(); xhttp.onload = function() { document.getElementById(\"ret_msg\").innerHTML = this.responseText; document.getElementById(\"ret_msg\").style.color = \"red\"; }; xhttp.open(\"POST\", \"/store_config\"); xhttp.send(configJSON); } function Load() { const xhttp = new XMLHttpRequest(); xhttp.onload = function() { var obj = JSON.parse(this.responseText); if (obj.wifi_mode == \"APStation\") { document.getElementById(\"wifi_mode\").selectedIndex = \"1\"; document.getElementById(\"ssid_value\").disabled = false; document.getElementById(\"pass_value\").disabled = false; } else if (obj.wifi_mode == \"AP\") { document.getElementById(\"wifi_mode\").selectedIndex = \"0\"; document.getElementById(\"ssid_value\").disabled = true; document.getElementById(\"pass_value\").disabled = true; } var ch = parseInt(obj.ap_ch); ch = ch - 1; document.getElementById(\"ap_ch_value\").selectedIndex = ch.toString(); document.getElementById(\"ssid_value\").value = obj.sta_ssid; document.getElementById(\"pass_value\").value = obj.sta_pass; if (obj.can_datarate == \"5K\") { document.getElementById(\"can_datarate\").selectedIndex = \"0\"; } else if (obj.can_datarate == \"10K\") { document.getElementById(\"can_datarate\").selectedIndex = \"1\"; } else if (obj.can_datarate == \"20K\") { document.getElementById(\"can_datarate\").selectedIndex = \"2\"; }else if (obj.can_datarate == \"25K\") { document.getElementById(\"can_datarate\").selectedIndex = \"3\"; } else if (obj.can_datarate == \"50K\") { document.getElementById(\"can_datarate\").selectedIndex = \"4\"; } else if (obj.can_datarate == \"100K\") { document.getElementById(\"can_datarate\").selectedIndex = \"5\"; } else if (obj.can_datarate == \"125K\") { document.getElementById(\"can_datarate\").selectedIndex = \"6\"; } else if (obj.can_datarate == \"250K\") { document.getElementById(\"can_datarate\").selectedIndex = \"7\"; } else if (obj.can_datarate == \"500K\") { document.getElementById(\"can_datarate\").selectedIndex = \"8\"; } else if (obj.can_datarate == \"800K\") { document.getElementById(\"can_datarate\").selectedIndex = \"9\"; } else if (obj.can_datarate == \"1000K\") { document.getElementById(\"can_datarate\").selectedIndex = \"10\"; } if (obj.can_mode == \"normal\") { document.getElementById(\"can_mode\").selectedIndex = \"0\"; } else if (obj.can_mode == \"silent\") { document.getElementById(\"can_mode\").selectedIndex = \"1\"; } if (obj.port_type == \"tcp\") { document.getElementById(\"port_type\").selectedIndex = \"0\"; } else if (obj.port_type == \"udp\") { document.getElementById(\"port_type\").selectedIndex = \"1\"; } document.getElementById(\"protocol\").value = obj.protocol; document.getElementById(\"tcp_port_value\").value = obj.port; document.getElementById(\"ap_pass_value\").value = obj.ap_pass; document.getElementById(\"ret_msg\").innerHTML = \" \"; }; checkStatus(); xhttp.open(\"GET\", \"/load_config\"); xhttp.send(); } </script> </body></html>"};
...
//static const char webpage[] = {"<!DOCTYPE html><html> <head> <meta name=\"viewport\" content=\"width=device-width, initial-scale=1\"> <title>Wi-CAN</title> <style> body { font-family: Arial; } .tab { overflow: hidden; border: 1px solid #24478f; background-color: #c2d1f0; width: 100%; } .tab button { background-color: inherit; float: left; border: none; outline: none; cursor: pointer; padding: 14px 16px; transition: 0.3s; font-size: 17px; } .tab button:hover { background-color: #ddd; } .tab button.active { background-color: #24478f; color: white; } .tabcontent { display: none; padding: 6px 12px; border: 1px solid #24478f; border-top: none; } table, th, td { border-collapse: collapse; border-spacing: 0; width: 350px; text-align: left; padding: 8px; } </style> </head> <body onload=\"Load()\"> <embed src=\"/logo.svg\" style=\"width:165px;height:66px;display: block;\" /> <div class=\"tab\"> <button class=\"tablinks\" onclick=\"openTab(event, 'status_view')\" id=\"defaultOpen\"> <b>Status</b> </button> <button class=\"tablinks\" onclick=\"openTab(event, 'wifi_settings')\"> <b>Settings</b> </button> <button class=\"tablinks\" onclick=\"openTab(event, 'about_tab')\"> <b>About</b> </button> </div> <div id=\"status_view\" class=\"tabcontent\"> <table> <tr> <td> <b>WiFi Mode:</b> </td> <td> <div id=\"wifi_mode_current\"> AP&nbsp; </div> </td> </tr> <tr> <td> <b>AP Channel:</b> </td> <td> <div id=\"ap_channel_status\"> 6&nbsp; </div> </td> </tr> <tr> <td> <b>WiFi Station:</b> </td> <td> <div id=\"sta_status\"> Not Connected&nbsp; </div> </td> </tr> <tr> <td> <b>BLE:</b> </td> <td> <div id=\"ble_status\"> Disabled&nbsp; </div> </td> </tr> <tr> <td> <b>Station IP:</b> </td> <td> <div id=\"sta_ip\"> 192.168.3.1&nbsp; </div> </td> </tr> <tr> <td> <b>CAN Bitrate:</b> </td> <td> <div id=\"can_bitrate_status\"> 500K&nbsp; </div> </td> </tr> <tr> <td> <b>CAN Mode:</b> </td> <td> <div id=\"can_mode_status\"> Silent&nbsp; </div> </td> </tr> <tr> <td> <b>Port Type:</b> </td> <td> <div id=\"port_type_status\"> TCP&nbsp; </div> </td> </tr> <tr> <td> <b>TCP/UDP Port:</b> </td> <td> <div id=\"port_status\"> 3333&nbsp; </div> </td> </tr> <tr> <td> <input id=\"check_status_button\" name=\"check_status_button\" type=\"button\" onclick=\"checkStatus()\" value=\"Check status\"> </td> <td>&nbsp;</td> </tr> </table> </div> <form id=\"configForm\" name=\"configForm\" action=\"/action_page\" onchange=\"submit_enable();\" onfocus=\"this.selectedIndex = -1;\"> <div id=\"wifi_settings\" class=\"tabcontent\"> <table> <tr> <td> <b> <u>AP Config:</u> </b> </td> <td>&nbsp;</td> </tr> <tr> <td> <label for=\"wifi_mode\"> <b>Mode:</b> </label> </td> <td> <select name=\"wifi_mode\" style=\"width: 93px\" id=\"wifi_mode\"> <option value=\"AP\">Ap</option> <option value=\"APStation\">AP+Station</option> </select> </td> </tr> <tr> <td> <b>AP Channel:</b> </td> <td> <select name=\"ap_ch_value\" style=\"width: 93px\" id=\"ap_ch_value\"> <option value=\"1\">1</option> <option value=\"2\">2</option> <option value=\"3\">3</option> <option value=\"4\">4</option> <option value=\"5\">5</option> <option value=\"6\">6</option> <option value=\"7\">7</option> <option value=\"8\">8</option> <option value=\"9\">9</option> <option value=\"10\">10</option> <option value=\"11\">11</option> <option value=\"12\">12</option> <option value=\"13\">13</option> <option value=\"14\">14</option> </select> </td> </tr> <tr> <td> <label for=\"ap_pass_value\"> <b>AP Password:</b> </label> </td> <td> <input type=\"text\" id=\"ap_pass_value\" name=\"ap_pass_value\" value=\"Testpass\"> </td> </tr> <tr> <td>&nbsp;</td> <td>&nbsp;</td> </tr> <tr> <td> <b> <u>Station Config:</u> </b> </td> <td>&nbsp;</td> </tr> <tr> <td> <label for=\"ssid_value\"> <b>SSID:</b> </label> </td> <td> <input type=\"text\" id=\"ssid_value\" name=\"ssid_value\" value=\"MeatPi\" disabled> </td> </tr> <tr> <td> <label for=\"pass_value\"> <b>Password:</b> </label> </td> <td> <input type=\"text\" id=\"pass_value\" name=\"pass_value\" value=\"TomatoSauce\" disabled> </td> </tr> <tr> <td>&nbsp;</td> <td>&nbsp;</td> </tr> <tr> <td> <b> <u>CAN:</u> </b> </td> <td>&nbsp;</td> </tr> <tr> <td> <label for=\"can_datarate\"> <b>CAN Bitrate:</b> </label> </td> <td> <select name=\"can_datarate\" style=\"width: 93px\" id=\"can_datarate\"> <option value=\"5K\">5K</option> <option value=\"10K\">10K</option> <option value=\"20K\">20K</option> <option value=\"25K\">25K</option> <option value=\"50K\">50K</option> <option value=\"100K\">100K</option> <option value=\"125K\">125K</option> <option value=\"250K\">250K</option> <option value=\"500K\">500K</option> <option value=\"800K\">800K</option> <option value=\"1000K\">1000K</option> </select> </td> </tr> <tr> <td> <label for=\"can_mode\"> <b>CAN Mode:</b> </label> </td> <td> <select name=\"can_mode\" style=\"width: 93px\" id=\"can_mode\"> <option value=\"normal\" selected=\"selected\">Normal</option> <option value=\"silent\">Silent</option> </select> </td> </tr> <tr> <td> <label for=\"port_type\"> <b>Port Type:</b> </label> </td> <td> <select name=\"port_type\" style=\"width: 93px\" id=\"port_type\"> <option value=\"tcp\">TCP</option> <option value=\"udp\">UDP</option> </select> </td> </tr> <tr> <td> <label for=\"tcp_port_value\"> <b>TCP/UDP Port:</b> </label> </td> <td> <input type=\"number\" id=\"tcp_port_value\" name=\"tcp_port_value\" value=\"3333\" min=\"1\" max=\"65535\"> </td> </tr> <tr> <td> <label for=\"protocol\"> <b>Protocol:</b> </label> </td> <td> <select name=\"protocol\" style=\"width: 93px\" id=\"protocol\"> <option value=\"realdash66\">realdash66</option> <option value=\"slcan\">slcan</option> </select> </td> </tr> <tr> <td>&nbsp;</td> <td>&nbsp;</td> </tr> <tr> <td> <b> <u>BLE:</u> </b> </td> <td>&nbsp;</td> </tr> <tr> <td> <label for=\"ble_pass_value\"> <b>Passkey:</b> </label> </td> <td> <input type=\"number\" id=\"ble_pass_value\" name=\"ble_pass_value\" value=\"000000\" min=\"0\" max=\"999999\"> </td> </tr> <tr> <td> <div id=\"tcp_txt\"> &nbsp; </div> </td> <td>&nbsp;</td> </tr> </table> <div id=\"note\"> <u> <b>Note:</b> If you forget the AP password, connect usb cable to recover </u> </div> </div> <div id=\"about_tab\" class=\"tabcontent\"> <table> <tr> <td> <b>Firmware ver:</b> </td> <td> <div id=\"fw_version\"> v1.00 </div> </td> </tr> <tr> <td> <b>Hardware ver:</b> </td> <td> <div id=\"hw_version\"> v2.10 </div> </td> </tr> <tr> <td> <b>Designed By:</b> </td> <td> <div id=\"made_by\"> <a href=\"https://www.meatpi.com/\"> <b>meatpi.com</b> </a> </div> </td> </tr> </table> </div> <div id=\"ret_msg\"> &nbsp; </div> </form> <input id=\"submit_button\" name=\"submit_button\" type=\"button\" onclick=\"postConfig()\" value=\"Submit Changes\" disabled> <script> function openTab(evt, tabName) { var i, tabcontent, tablinks; tabcontent = document.getElementsByClassName(\"tabcontent\"); for (i = 0; i < tabcontent.length; i++) { tabcontent[i].style.display = \"none\"; } tablinks = document.getElementsByClassName(\"tablinks\"); for (i = 0; i < tablinks.length; i++) { tablinks[i].className = tablinks[i].className.replace(\" active\", \"\"); } document.getElementById(tabName).style.display = \"block\"; evt.currentTarget.className += \" active\"; } function sta_enable() {} function submit_enable() { if (document.getElementById(\"wifi_mode\").value == \"AP\") { document.getElementById(\"ssid_value\").disabled = true; document.getElementById(\"pass_value\").disabled = true; } else { document.getElementById(\"ssid_value\").disabled = false; document.getElementById(\"pass_value\").disabled = false; } if (document.getElementById(\"ap_pass_value\").value.length < 8 || document.getElementById(\"ap_pass_value\").value.length > 63 || document.getElementById(\"pass_value\").value.length < 8 || document.getElementById(\"pass_value\").value.length > 63) { document.getElementById(\"ret_msg\").innerHTML = \"AP/station password len, min=0 max=64\"; document.getElementById(\"ret_msg\").style.color = \"red\"; document.getElementById(\"submit_button\").disabled = true; } else if (document.getElementById(\"ssid_value\").value.length < 1 || document.getElementById(\"ssid_value\").value.length > 32) { document.getElementById(\"ret_msg\").innerHTML = \"AP/station ssid len, min=1 max=32\"; document.getElementById(\"ret_msg\").style.color = \"red\"; document.getElementById(\"submit_button\").disabled = true; } else if (document.getElementById(\"tcp_port_value\").value > 65535 || document.getElementById(\"tcp_port_value\").value < 1) { document.getElementById(\"ret_msg\").innerHTML = \"Port value, min=1 max=65535\"; document.getElementById(\"ret_msg\").style.color = \"red\"; document.getElementById(\"submit_button\").disabled = true; } else if (document.getElementById(\"ble_pass_value\").value.length != 6 ) { document.getElementById(\"ret_msg\").innerHTML = \"Passkey length, min=6 max=6\"; document.getElementById(\"ret_msg\").style.color = \"red\"; document.getElementById(\"submit_button\").disabled = true; } else { document.getElementById(\"submit_button\").disabled = false; document.getElementById(\"ret_msg\").innerHTML = \" \" } } document.getElementById(\"defaultOpen\").click(); function checkStatus() { const xhttp = new XMLHttpRequest(); xhttp.onload = function() { var obj = JSON.parse(this.responseText); if (obj.wifi_mode == \"APStation\") { document.getElementById(\"wifi_mode_current\").innerHTML = \"AP+Station\"; } else if (obj.wifi_mode == \"AP\") { document.getElementById(\"wifi_mode_current\").innerHTML = \"AP\"; } document.getElementById(\"sta_status\").innerHTML = obj.sta_status; document.getElementById(\"ap_channel_status\").innerHTML = obj.ap_ch; document.getElementById(\"sta_ip\").innerHTML = obj.sta_ip; document.getElementById(\"ble_status\").innerHTML = obj.ble_status; document.getElementById(\"can_bitrate_status\").innerHTML = obj.can_datarate; if (obj.can_mode == \"normal\") { document.getElementById(\"can_mode_status\").innerHTML = \"Normal\"; } else if (obj.can_mode == \"silent\") { document.getElementById(\"can_mode_status\").innerHTML = \"Silent\"; } if (obj.port_type == \"tcp\") { document.getElementById(\"port_type_status\").innerHTML = \"TCP\"; } else if (obj.port_type == \"udp\") { document.getElementById(\"port_type_status\").innerHTML = \"UDP\"; } document.getElementById(\"port_status\").innerHTML = obj.port; document.getElementById(\"fw_version\").value = obj.fw_version; document.getElementById(\"hw_version\").value = obj.hw_version; document.getElementById(\"protocol\").value = obj.protocol; document.getElementById(\"ret_msg\").innerHTML = \" \"; }; xhttp.open(\"GET\", \"/check_status\"); xhttp.send(); } function postConfig() { var obj = {}; obj[\"wifi_mode\"] = document.getElementById(\"wifi_mode\").value; obj[\"ap_ch\"] = document.getElementById(\"ap_ch_value\").value; obj[\"sta_ssid\"] = document.getElementById(\"ssid_value\").value; obj[\"sta_pass\"] = document.getElementById(\"pass_value\").value; obj[\"can_datarate\"] = document.getElementById(\"can_datarate\").value; obj[\"can_mode\"] = document.getElementById(\"can_mode\").value; obj[\"port_type\"] = document.getElementById(\"port_type\").value; obj[\"port\"] = document.getElementById(\"tcp_port_value\").value; obj[\"ap_pass\"] = document.getElementById(\"ap_pass_value\").value; obj[\"protocol\"] = document.getElementById(\"protocol\").value;obj[\"ble_pass\"] = document.getElementById(\"ble_pass_value\").value; var configJSON = JSON.stringify(obj); const xhttp = new XMLHttpRequest(); xhttp.onload = function() { document.getElementById(\"ret_msg\").innerHTML = this.responseText; document.getElementById(\"ret_msg\").style.color = \"red\"; }; xhttp.open(\"POST\", \"/store_config\"); xhttp.send(configJSON); } function Load() { const xhttp = new XMLHttpRequest(); xhttp.onload = function() { var obj = JSON.parse(this.responseText); if (obj.wifi_mode == \"APStation\") { document.getElementById(\"wifi_mode\").selectedIndex = \"1\"; document.getElementById(\"ssid_value\").disabled = false; document.getElementById(\"pass_value\").disabled = false; } else if (obj.wifi_mode == \"AP\") { document.getElementById(\"wifi_mode\").selectedIndex = \"0\"; document.getElementById(\"ssid_value\").disabled = true; document.getElementById(\"pass_value\").disabled = true; } var ch = parseInt(obj.ap_ch); ch = ch - 1; document.getElementById(\"ap_ch_value\").selectedIndex = ch.toString(); document.getElementById(\"ssid_value\").value = obj.sta_ssid; document.getElementById(\"pass_value\").value = obj.sta_pass; if (obj.can_datarate == \"5K\") { document.getElementById(\"can_datarate\").selectedIndex = \"0\"; } else if (obj.can_datarate == \"10K\") { document.getElementById(\"can_datarate\").selectedIndex = \"1\"; } else if (obj.can_datarate == \"20K\") { document.getElementById(\"can_datarate\").selectedIndex = \"2\"; } else if (obj.can_datarate == \"25K\") { document.getElementById(\"can_datarate\").selectedIndex = \"3\"; } else if (obj.can_datarate == \"50K\") { document.getElementById(\"can_datarate\").selectedIndex = \"4\"; } else if (obj.can_datarate == \"100K\") { document.getElementById(\"can_datarate\").selectedIndex = \"5\"; } else if (obj.can_datarate == \"125K\") { document.getElementById(\"can_datarate\").selectedIndex = \"6\"; } else if (obj.can_datarate == \"250K\") { document.getElementById(\"can_datarate\").selectedIndex = \"7\"; } else if (obj.can_datarate == \"500K\") { document.getElementById(\"can_datarate\").selectedIndex = \"8\"; } else if (obj.can_datarate == \"800K\") { document.getElementById(\"can_datarate\").selectedIndex = \"9\"; } else if (obj.can_datarate == \"1000K\") { document.getElementById(\"can_datarate\").selectedIndex = \"10\"; } if (obj.can_mode == \"normal\") { document.getElementById(\"can_mode\").selectedIndex = \"0\"; } else if (obj.can_mode == \"silent\") { document.getElementById(\"can_mode\").selectedIndex = \"1\"; } if (obj.port_type == \"tcp\") { document.getElementById(\"port_type\").selectedIndex = \"0\"; } else if (obj.port_type == \"udp\") { document.getElementById(\"port_type\").selectedIndex = \"1\"; } document.getElementById(\"protocol\").value = obj.protocol; document.getElementById(\"tcp_port_value\").value = obj.port; document.getElementById(\"ap_pass_value\").value = obj.ap_pass; document.getElementById(\"ble_pass_value\").value = obj.ble_pass; document.getElementById(\"ret_msg\").innerHTML = \" \"; }; checkStatus(); xhttp.open(\"GET\", \"/load_config\"); xhttp.send(); } </script> </body></html>"};

//static const char webpage[] = {"<!DOCTYPE html><html> <head> <meta name=\"viewport\" content=\"width=device-width, initial-scale=1\"> <title>WiCAN</title> <style> body { font-family: Arial; } .tab { overflow: hidden; border: 1px solid #24478f; background-color: #c2d1f0; width: 100%; } .tab button { background-color: inherit; float: left; border: none; outline: none; cursor: pointer; padding: 14px 16px; transition: 0.3s; font-size: 17px; } .tab button:hover { background-color: #ddd; } .tab button.active { background-color: #24478f; color: white; } .tabcontent { display: none; padding: 6px 12px; border: 1px solid #24478f; border-top: none; } table, th, td { border-collapse: collapse; border-spacing: 0; width: 350px; text-align: left; padding: 8px; }#table1 { width: 350px; text-align: left; padding: 8px;}#table2 { width: 350px; text-align: left;max-width: 350;font-size:60%;white-space: nowrap;} </style> </head> <body onload=\"Load()\"> <embed src=\"/logo.svg\" style=\"width:165px;height:66px;display: block;\" /> <div class=\"tab\"> <button class=\"tablinks\" onclick=\"openTab(event, 'status_view')\" id=\"defaultOpen\"> <b>Status</b> </button> <button class=\"tablinks\" onclick=\"openTab(event, 'wifi_settings')\"> <b>Settings</b> </button> <button class=\"tablinks\" onclick=\"openTab(event, 'monitor')\"> <b>Monitor</b> </button> <button class=\"tablinks\" onclick=\"openTab(event, 'about_tab')\"> <b>About</b> </button> </div> <div id=\"status_view\" class=\"tabcontent\"> <table> <tr> <td> <b>WiFi Mode:</b> </td> <td> <div id=\"wifi_mode_current\"> AP&nbsp; </div> </td> </tr> <tr> <td> <b>AP Channel:</b> </td> <td> <div id=\"ap_channel_status\"> 6&nbsp; </div> </td> </tr> <tr> <td> <b>WiFi Station:</b> </td> <td> <div id=\"sta_status\"> Not Connected&nbsp; </div> </td> </tr> <tr> <td> <b>Station IP:</b> </td> <td> <div id=\"sta_ip\"> 192.168.3.1&nbsp; </div> </td> </tr> <tr> <td> <b>CAN Bitrate:</b> </td> <td> <div id=\"can_bitrate_status\"> 500K&nbsp; </div> </td> </tr> <tr> <td> <b>CAN Mode:</b> </td> <td> <div id=\"can_mode_status\"> Silent&nbsp; </div> </td> </tr> <tr> <td> <b>Port Type:</b> </td> <td> <div id=\"port_type_status\"> TCP&nbsp; </div> </td> </tr> <tr> <td> <b>TCP/UDP Port:</b> </td> <td> <div id=\"port_status\"> 3333&nbsp; </div> </td> </tr> <tr> <td> <input id=\"check_status_button\" name=\"check_status_button\" type=\"button\" onclick=\"checkStatus()\" value=\"Check status\"> </td> <td>&nbsp;</td> </tr> </table> </div> <form id=\"configForm\" name=\"configForm\" action=\"/action_page\" onchange=\"submit_enable();\" onfocus=\"this.selectedIndex = -1;\"> <div id=\"wifi_settings\" class=\"tabcontent\"> <table> <tr> <td> <b> <u>AP Config:</u> </b> </td> <td>&nbsp;</td> </tr> <tr> <td> <label for=\"wifi_mode\"> <b>Mode:</b> </label> </td> <td> <select name=\"wifi_mode\" style=\"width: 93px\" id=\"wifi_mode\"> <option value=\"AP\">Ap</option> <option value=\"APStation\">AP+Station</option> </select> </td> </tr> <tr> <td> <b>AP Channel:</b> </td> <td> <select name=\"ap_ch_value\" style=\"width: 93px\" id=\"ap_ch_value\"> <option value=\"1\">1</option> <option value=\"2\">2</option> <option value=\"3\">3</option> <option value=\"4\">4</option> <option value=\"5\">5</option> <option value=\"6\">6</option> <option value=\"7\">7</option> <option value=\"8\">8</option> <option value=\"9\">9</option> <option value=\"10\">10</option> <option value=\"11\">11</option> <option value=\"12\">12</option> <option value=\"13\">13</option> <option value=\"14\">14</option> </select> </td> </tr> <tr> <td> <label for=\"ap_pass_value\"> <b>AP Password:</b> </label> </td> <td> <input type=\"text\" id=\"ap_pass_value\" name=\"ap_pass_value\" value=\"Testpass\"> </td> </tr> <tr> <td>&nbsp;</td> <td>&nbsp;</td> </tr> <tr> <td> <b> <u>Station Config:</u> </b> </td> <td>&nbsp;</td> </tr> <tr> <td> <label for=\"ssid_value\"> <b>SSID:</b> </label> </td> <td> <input type=\"text\" id=\"ssid_value\" name=\"ssid_value\" value=\"MeatPi\" disabled> </td> </tr> <tr> <td> <label for=\"pass_value\"> <b>Password:</b> </label> </td> <td> <input type=\"text\" id=\"pass_value\" name=\"pass_value\" value=\"TomatoSauce\" disabled> </td> </tr> <tr> <td>&nbsp;</td> <td>&nbsp;</td> </tr> <tr> <td> <b> <u>CAN:</u> </b> </td> <td>&nbsp;</td> </tr> <tr> <td> <label for=\"can_datarate\"> <b>CAN Bitrate:</b> </label> </td> <td> <select name=\"can_datarate\" style=\"width: 93px\" id=\"can_datarate\"> <option value=\"5K\">5K</option> <option value=\"10K\">10K</option> <option value=\"20K\">20K</option> <option value=\"25K\">25K</option> <option value=\"50K\">50K</option> <option value=\"100K\">100K</option> <option value=\"125K\">125K</option> <option value=\"250K\">250K</option> <option value=\"500K\">500K</option> <option value=\"800K\">800K</option> <option value=\"1000K\">1000K</option> </select> </td> </tr> <tr> <td> <label for=\"can_mode\"> <b>CAN Mode:</b> </label> </td> <td> <select name=\"can_mode\" style=\"width: 93px\" id=\"can_mode\"> <option value=\"normal\" selected=\"selected\">Normal</option> <option value=\"silent\">Silent</option> </select> </td> </tr> <tr> <td> <label for=\"port_type\"> <b>Port Type:</b> </label> </td> <td> <select name=\"port_type\" style=\"width: 93px\" id=\"port_type\"> <option value=\"tcp\">TCP</option> <option value=\"udp\">UDP</option> </select> </td> </tr> <tr> <td> <label for=\"tcp_port_value\"> <b>TCP/UDP Port:</b> </label> </td> <td> <input type=\"number\" id=\"tcp_port_value\" name=\"tcp_port_value\" value=\"3333\" min=\"1\" max=\"65535\"> </td> </tr> <tr> <td> <label for=\"protocol\"> <b>Protocol:</b> </label> </td> <td> <select name=\"protocol\" style=\"width: 93px\" id=\"protocol\"> <option value=\"realdash66\">realdash66</option> <option value=\"slcan\">slcan</option> </select> </td> </tr> <tr> <td>&nbsp;</td> <td>&nbsp;</td> </tr> <tr> <td> <b> <u>BLE:</u> </b> </td> <td>&nbsp;</td> </tr> <tr> <td> <label for=\"ble_pass_value\"> <b>Passkey:</b> </label> </td> <td> <input type=\"number\" id=\"ble_pass_value\" name=\"ble_pass_value\" value=\"000000\" min=\"0\" max=\"999999\"> </td> </tr> <tr> <td> <label for=\"ble_status\"> <b>BLE Status:</b> </label> </td> <td> <select name=\"ble_status\" style=\"width: 93px\" id=\"ble_status\"> <option value=\"enable\">Enable</option> <option value=\"disable\">Disable</option> </select> </td> </tr> <tr> <td> <div id=\"tcp_txt\"> &nbsp; </div> </td> <td>&nbsp;</td> </tr> </table> <div id=\"note\"> <u> <b>Note:</b> If you forget the AP password, connect usb cable to recover </u> </div> </div> <div id=\"monitor\" class=\"tabcontent\"> <table id=\"table2\" > <tr> <td> <b>ID</b> </td> <td> <b>Type</b> </td><td> <b>Len</b> </td><td style=\"width:80%\"> <b>Data</b> </td><td> <b>Time</b> </td><td> <b>Count</b> </td> </tr> <tr> <td> 100 </td> <td> Data </td><td> 8 </td><td> 11 22 33 44 55 66 77 88 </td><td> 100 </td><td> 23 </td> </tr> </table> <table id=\"table2\"> <tr> <td> <input id=\"start_mon\" name=\"start_mon\" type=\"button\" onclick=\"monitor_add_line('100','Data',8,'11 22 33 44 55 66 77 88','120')\" value=\"Start\"> </td> <td> <input id=\"stop_mon\" name=\"stop_mon\" type=\"button\" onclick=\"monitor_add_line('110','Data',8,'11 22 33 44 55 66 77 88','120')\" value=\"Stop\"> </td> <td>&nbsp;</td><td>&nbsp;</td><td>&nbsp;</td><td>&nbsp;</td> </tr> </table> </div> <div id=\"about_tab\" class=\"tabcontent\"> <table> <tr> <td> <b>Firmware ver:</b> </td> <td> <div id=\"fw_version\"> v1.00 </div> </td> </tr> <tr> <td> <b>Hardware ver:</b> </td> <td> <div id=\"hw_version\"> v2.10 </div> </td> </tr> <tr> <td> <b>Designed By:</b> </td> <td> <div id=\"made_by\"> <a href=\"https://www.meatpi.com/\"> <b>meatpi.com</b> </a> </div> </td> </tr> </table> </div> <div id=\"ret_msg\"> &nbsp; </div> </form> <input id=\"submit_button\" name=\"submit_button\" type=\"button\" onclick=\"postConfig()\" value=\"Submit Changes\" disabled> <script> function openTab(evt, tabName) { var i, tabcontent, tablinks; tabcontent = document.getElementsByClassName(\"tabcontent\"); for (i = 0; i < tabcontent.length; i++) { tabcontent[i].style.display = \"none\"; } tablinks = document.getElementsByClassName(\"tablinks\"); for (i = 0; i < tablinks.length; i++) { tablinks[i].className = tablinks[i].className.replace(\" active\", \"\"); } document.getElementById(tabName).style.display = \"block\"; evt.currentTarget.className += \" active\"; } function sta_enable() {} function submit_enable() { if (document.getElementById(\"wifi_mode\").value == \"AP\") { document.getElementById(\"ssid_value\").disabled = true; document.getElementById(\"pass_value\").disabled = true; } else { document.getElementById(\"ssid_value\").disabled = false; document.getElementById(\"pass_value\").disabled = false; } if (document.getElementById(\"ap_pass_value\").value.length < 8 || document.getElementById(\"ap_pass_value\").value.length > 63 || document.getElementById(\"pass_value\").value.length < 8 || document.getElementById(\"pass_value\").value.length > 63) { document.getElementById(\"ret_msg\").innerHTML = \"AP/station password len, min=0 max=64\"; document.getElementById(\"ret_msg\").style.color = \"red\"; document.getElementById(\"submit_button\").disabled = true; } else if (document.getElementById(\"ssid_value\").value.length < 1 || document.getElementById(\"ssid_value\").value.length > 32) { document.getElementById(\"ret_msg\").innerHTML = \"AP/station ssid len, min=1 max=32\"; document.getElementById(\"ret_msg\").style.color = \"red\"; document.getElementById(\"submit_button\").disabled = true; } else if (document.getElementById(\"tcp_port_value\").value > 65535 || document.getElementById(\"tcp_port_value\").value < 1) { document.getElementById(\"ret_msg\").innerHTML = \"Port value, min=1 max=65535\"; document.getElementById(\"ret_msg\").style.color = \"red\"; document.getElementById(\"submit_button\").disabled = true; } else if (document.getElementById(\"ble_pass_value\").value.length != 6) { document.getElementById(\"ret_msg\").innerHTML = \"Passkey length, min=6 max=6\"; document.getElementById(\"ret_msg\").style.color = \"red\"; document.getElementById(\"submit_button\").disabled = true; } else { document.getElementById(\"submit_button\").disabled = false; document.getElementById(\"ret_msg\").innerHTML = \" \" } } document.getElementById(\"defaultOpen\").click(); function checkStatus() { const xhttp = new XMLHttpRequest(); xhttp.onload = function() { var obj = JSON.parse(this.responseText); if (obj.wifi_mode == \"APStation\") { document.getElementById(\"wifi_mode_current\").innerHTML = \"AP+Station\"; } else if (obj.wifi_mode == \"AP\") { document.getElementById(\"wifi_mode_current\").innerHTML = \"AP\"; } document.getElementById(\"sta_status\").innerHTML = obj.sta_status; document.getElementById(\"ap_channel_status\").innerHTML = obj.ap_ch; document.getElementById(\"sta_ip\").innerHTML = obj.sta_ip; document.getElementById(\"can_bitrate_status\").innerHTML = obj.can_datarate; if (obj.can_mode == \"normal\") { document.getElementById(\"can_mode_status\").innerHTML = \"Normal\"; } else if (obj.can_mode == \"silent\") { document.getElementById(\"can_mode_status\").innerHTML = \"Silent\"; } if (obj.port_type == \"tcp\") { document.getElementById(\"port_type_status\").innerHTML = \"TCP\"; } else if (obj.port_type == \"udp\") { document.getElementById(\"port_type_status\").innerHTML = \"UDP\"; } document.getElementById(\"port_status\").innerHTML = obj.port; document.getElementById(\"fw_version\").value = obj.fw_version; document.getElementById(\"hw_version\").value = obj.hw_version; document.getElementById(\"protocol\").value = obj.protocol; document.getElementById(\"ret_msg\").innerHTML = \" \"; }; xhttp.open(\"GET\", \"/check_status\"); xhttp.send(); } function postConfig() { var obj = {}; obj[\"wifi_mode\"] = document.getElementById(\"wifi_mode\").value; obj[\"ap_ch\"] = document.getElementById(\"ap_ch_value\").value; obj[\"sta_ssid\"] = document.getElementById(\"ssid_value\").value; obj[\"sta_pass\"] = document.getElementById(\"pass_value\").value; obj[\"can_datarate\"] = document.getElementById(\"can_datarate\").value; obj[\"can_mode\"] = document.getElementById(\"can_mode\").value; obj[\"port_type\"] = document.getElementById(\"port_type\").value; obj[\"port\"] = document.getElementById(\"tcp_port_value\").value; obj[\"ap_pass\"] = document.getElementById(\"ap_pass_value\").value; obj[\"protocol\"] = document.getElementById(\"protocol\").value; obj[\"ble_pass\"] = document.getElementById(\"ble_pass_value\").value; obj[\"ble_status\"] = document.getElementById(\"ble_status\").value; var configJSON = JSON.stringify(obj); const xhttp = new XMLHttpRequest(); xhttp.onload = function() { document.getElementById(\"ret_msg\").innerHTML = this.responseText; document.getElementById(\"ret_msg\").style.color = \"red\"; }; xhttp.open(\"POST\", \"/store_config\"); xhttp.send(configJSON); } function Load() { const xhttp = new XMLHttpRequest(); xhttp.onload = function() { var obj = JSON.parse(this.responseText); if (obj.wifi_mode == \"APStation\") { document.getElementById(\"wifi_mode\").selectedIndex = \"1\"; document.getElementById(\"ssid_value\").disabled = false; document.getElementById(\"pass_value\").disabled = false; } else if (obj.wifi_mode == \"AP\") { document.getElementById(\"wifi_mode\").selectedIndex = \"0\"; document.getElementById(\"ssid_value\").disabled = true; document.getElementById(\"pass_value\").disabled = true; } var ch = parseInt(obj.ap_ch); ch = ch - 1; document.getElementById(\"ap_ch_value\").selectedIndex = ch.toString(); document.getElementById(\"ssid_value\").value = obj.sta_ssid; document.getElementById(\"pass_value\").value = obj.sta_pass; if (obj.can_datarate == \"5K\") { document.getElementById(\"can_datarate\").selectedIndex = \"0\"; } else if (obj.can_datarate == \"10K\") { document.getElementById(\"can_datarate\").selectedIndex = \"1\"; } else if (obj.can_datarate == \"20K\") { document.getElementById(\"can_datarate\").selectedIndex = \"2\"; } else if (obj.can_datarate == \"25K\") { document.getElementById(\"can_datarate\").selectedIndex = \"3\"; } else if (obj.can_datarate == \"50K\") { document.getElementById(\"can_datarate\").selectedIndex = \"4\"; } else if (obj.can_datarate == \"100K\") { document.getElementById(\"can_datarate\").selectedIndex = \"5\"; } else if (obj.can_datarate == \"125K\") { document.getElementById(\"can_datarate\").selectedIndex = \"6\"; } else if (obj.can_datarate == \"250K\") { document.getElementById(\"can_datarate\").selectedIndex = \"7\"; } else if (obj.can_datarate == \"500K\") { document.getElementById(\"can_datarate\").selectedIndex = \"8\"; } else if (obj.can_datarate == \"800K\") { document.getElementById(\"can_datarate\").selectedIndex = \"9\"; } else if (obj.can_datarate == \"1000K\") { document.getElementById(\"can_datarate\").selectedIndex = \"10\"; } if (obj.can_mode == \"normal\") { document.getElementById(\"can_mode\").selectedIndex = \"0\"; } else if (obj.can_mode == \"silent\") { document.getElementById(\"can_mode\").selectedIndex = \"1\"; } if (obj.port_type == \"tcp\") { document.getElementById(\"port_type\").selectedIndex = \"0\"; } else if (obj.port_type == \"udp\") { document.getElementById(\"port_type\").selectedIndex = \"1\"; } if (obj.ble_status == \"enable\") { document.getElementById(\"ble_status\").selectedIndex = \"0\"; } else if (obj.ble_status == \"disable\") { document.getElementById(\"ble_status\").selectedIndex = \"1\"; } document.getElementById(\"protocol\").value = obj.protocol; document.getElementById(\"tcp_port_value\").value = obj.port; document.getElementById(\"ap_pass_value\").value = obj.ap_pass; document.getElementById(\"ble_pass_value\").value = obj.ble_pass; document.getElementById(\"ret_msg\").innerHTML = \" \"; }; checkStatus(); xhttp.open(\"GET\", \"/load_config\"); xhttp.send(); }function monitor_add_line(id, type, len, data, time) {var table = document.getElementById(\"table2\");var nraw = -1;for (var r = 1, n = table.rows.length; r < n; r++) {if(table.rows[r].cells[0].innerHTML == id){nraw = r;break;}}if(nraw != -1){table.rows[nraw].cells[0].innerHTML = id;table.rows[nraw].cells[1].innerHTML = type;table.rows[nraw].cells[2].innerHTML = len;table.rows[nraw].cells[3].innerHTML = data;table.rows[nraw].cells[4].innerHTML = currentTimeInMilliseconds=Date.now()/1000;table.rows[nraw].cells[5].innerHTML = ++table.rows[nraw].cells[5].innerHTML;}else{var row = table.insertRow(1);var cell1 = row.insertCell(0);var cell2 = row.insertCell(1);var cell3 = row.insertCell(2);var cell4 = row.insertCell(3);var cell5 = row.insertCell(4);var cell6 = row.insertCell(5);cell1.innerHTML = id;cell2.innerHTML = type;cell3.innerHTML = len;cell4.innerHTML = data;cell5.innerHTML = currentTimeInMilliseconds=Date.now();cell6.innerHTML = 1;}} </script> </body></html>"};
//static const char webpage[] = {"<!DOCTYPE html><html> <head> <meta name=\"viewport\" content=\"width=device-width, initial-scale=1\"> <title>WiCAN</title> <style> body { font-family: Arial; } .tab { overflow: hidden; border: 1px solid #24478f; background-color: #c2d1f0; width: 100%; } .tab button { background-color: inherit; float: left; border: none; outline: none; cursor: pointer; padding: 14px 16px; transition: 0.3s; font-size: 17px; } .tab button:hover { background-color: #ddd; } .tab button.active { background-color: #24478f; color: white; } .tabcontent { display: none; padding: 6px 12px; border: 1px solid #24478f; border-top: none; } table, th, td { border-collapse: collapse; border-spacing: 0; width: 350px; text-align: left; padding: 8px; } #table1 { width: 350px; text-align: left; padding: 8px; } #table2 { width: 350px; text-align: left; max-width: 350; font-size: 70%; white-space: nowrap; } #table3 { width: 350px; text-align: left; max-width: 350; font-size: 80%;border: 1px solid; white-space: nowrap; } </style> </head> <body onload=\"Load()\"> <embed src=\"/logo.svg\" style=\"width:165px;height:66px;display: block;\" /> <div class=\"tab\"> <button class=\"tablinks\" onclick=\"openTab(event, 'status_view')\" id=\"defaultOpen\"> <b>Status</b> </button> <button class=\"tablinks\" onclick=\"openTab(event, 'wifi_settings')\"> <b>Settings</b> </button> <button class=\"tablinks\" onclick=\"openTab(event, 'monitor')\"> <b>Monitor</b> </button> <button class=\"tablinks\" onclick=\"openTab(event, 'about_tab')\"> <b>About</b> </button> </div> <div id=\"status_view\" class=\"tabcontent\"> <table> <tr> <td> <b>WiFi Mode:</b> </td> <td> <div id=\"wifi_mode_current\"> AP&nbsp; </div> </td> </tr> <tr> <td> <b>AP Channel:</b> </td> <td> <div id=\"ap_channel_status\"> 6&nbsp; </div> </td> </tr> <tr> <td> <b>WiFi Station:</b> </td> <td> <div id=\"sta_status\"> Not Connected&nbsp; </div> </td> </tr> <tr> <td> <b>Station IP:</b> </td> <td> <div id=\"sta_ip\"> 192.168.3.1&nbsp; </div> </td> </tr> <tr> <td> <b>CAN Bitrate:</b> </td> <td> <div id=\"can_bitrate_status\"> 500K&nbsp; </div> </td> </tr> <tr> <td> <b>CAN Mode:</b> </td> <td> <div id=\"can_mode_status\"> Silent&nbsp; </div> </td> </tr> <tr> <td> <b>Port Type:</b> </td> <td> <div id=\"port_type_status\"> TCP&nbsp; </div> </td> </tr> <tr> <td> <b>TCP/UDP Port:</b> </td> <td> <div id=\"port_status\"> 3333&nbsp; </div> </td> </tr> <tr> <td> <input id=\"check_status_button\" name=\"check_status_button\" type=\"button\" onclick=\"checkStatus()\" value=\"Check status\"> </td> <td>&nbsp;</td> </tr> </table> </div> <form id=\"configForm\" name=\"configForm\" action=\"/action_page\" onchange=\"submit_enable();\" onfocus=\"this.selectedIndex = -1;\"> <div id=\"wifi_settings\" class=\"tabcontent\"> <table> <tr> <td> <b> <u>AP Config:</u> </b> </td> <td>&nbsp;</td> </tr> <tr> <td> <label for=\"wifi_mode\"> <b>Mode:</b> </label> </td> <td> <select name=\"wifi_mode\" style=\"width: 93px\" id=\"wifi_mode\"> <option value=\"AP\">Ap</option> <option value=\"APStation\">AP+Station</option> </select> </td> </tr> <tr> <td> <b>AP Channel:</b> </td> <td> <select name=\"ap_ch_value\" style=\"width: 93px\" id=\"ap_ch_value\"> <option value=\"1\">1</option> <option value=\"2\">2</option> <option value=\"3\">3</option> <option value=\"4\">4</option> <option value=\"5\">5</option> <option value=\"6\">6</option> <option value=\"7\">7</option> <option value=\"8\">8</option> <option value=\"9\">9</option> <option value=\"10\">10</option> <option value=\"11\">11</option> <option value=\"12\">12</option> <option value=\"13\">13</option> <option value=\"14\">14</option> </select> </td> </tr> <tr> <td> <label for=\"ap_pass_value\"> <b>AP Password:</b> </label> </td> <td> <input type=\"text\" id=\"ap_pass_value\" name=\"ap_pass_value\" value=\"Testpass\"> </td> </tr> <tr> <td>&nbsp;</td> <td>&nbsp;</td> </tr> <tr> <td> <b> <u>Station Config:</u> </b> </td> <td>&nbsp;</td> </tr> <tr> <td> <label for=\"ssid_value\"> <b>SSID:</b> </label> </td> <td> <input type=\"text\" id=\"ssid_value\" name=\"ssid_value\" value=\"MeatPi\" disabled> </td> </tr> <tr> <td> <label for=\"pass_value\"> <b>Password:</b> </label> </td> <td> <input type=\"text\" id=\"pass_value\" name=\"pass_value\" value=\"TomatoSauce\" disabled> </td> </tr> <tr> <td>&nbsp;</td> <td>&nbsp;</td> </tr> <tr> <td> <b> <u>CAN:</u> </b> </td> <td>&nbsp;</td> </tr> <tr> <td> <label for=\"can_datarate\"> <b>CAN Bitrate:</b> </label> </td> <td> <select name=\"can_datarate\" style=\"width: 93px\" id=\"can_datarate\"> <option value=\"5K\">5K</option> <option value=\"10K\">10K</option> <option value=\"20K\">20K</option> <option value=\"25K\">25K</option> <option value=\"50K\">50K</option> <option value=\"100K\">100K</option> <option value=\"125K\">125K</option> <option value=\"250K\">250K</option> <option value=\"500K\">500K</option> <option value=\"800K\">800K</option> <option value=\"1000K\">1000K</option> </select> </td> </tr> <tr> <td> <label for=\"can_mode\"> <b>CAN Mode:</b> </label> </td> <td> <select name=\"can_mode\" style=\"width: 93px\" id=\"can_mode\"> <option value=\"normal\" selected=\"selected\">Normal</option> <option value=\"silent\">Silent</option> </select> </td> </tr> <tr> <td> <label for=\"port_type\"> <b>Port Type:</b> </label> </td> <td> <select name=\"port_type\" style=\"width: 93px\" id=\"port_type\"> <option value=\"tcp\">TCP</option> <option value=\"udp\">UDP</option> </select> </td> </tr> <tr> <td> <label for=\"tcp_port_value\"> <b>TCP/UDP Port:</b> </label> </td> <td> <input type=\"number\" id=\"tcp_port_value\" name=\"tcp_port_value\" value=\"3333\" min=\"1\" max=\"65535\"> </td> </tr> <tr> <td> <label for=\"protocol\"> <b>Protocol:</b> </label> </td> <td> <select name=\"protocol\" style=\"width: 93px\" id=\"protocol\"> <option value=\"realdash66\">realdash66</option> <option value=\"slcan\">slcan</option> </select> </td> </tr> <tr> <td>&nbsp;</td> <td>&nbsp;</td> </tr> <tr> <td> <b> <u>BLE:</u> </b> </td> <td>&nbsp;</td> </tr> <tr> <td> <label for=\"ble_pass_value\"> <b>Passkey:</b> </label> </td> <td> <input type=\"number\" id=\"ble_pass_value\" name=\"ble_pass_value\" value=\"000000\" min=\"0\" max=\"999999\"> </td> </tr> <tr> <td> <label for=\"ble_status\"> <b>BLE Status:</b> </label> </td> <td> <select name=\"ble_status\" style=\"width: 93px\" id=\"ble_status\"> <option value=\"enable\">Enable</option> <option value=\"disable\">Disable</option> </select> </td> </tr> <tr> <td> <div id=\"tcp_txt\"> &nbsp; </div> </td> <td>&nbsp;</td> </tr> </table> <div id=\"note\"> <u> <b>Note:</b> If you forget the AP password, connect usb cable to recover </u> </div> </div> <div id=\"monitor\" class=\"tabcontent\"> <table id=\"table3\" > <tr> <td><b>Bitrate</b> </td> <td> <b>Filter</b> </td> <td> <b>Mask</b> </td><td>&nbsp;</td> <td>&nbsp;</td> <td>&nbsp;</td> <td>&nbsp;</td> <td>&nbsp;</td> </tr> <tr> <td> <select name=\"mon_datarate\" id=\"mon_datarate\" style=\"font-size:100%;\"> <option value=\"10K\">10K</option> <option value=\"20K\">20K</option> <option value=\"50K\">50K</option> <option value=\"100K\">100K</option> <option value=\"125K\">125K</option> <option value=\"250K\">250K</option> <option value=\"500K\" selected=\"selected\">500K</option> <option value=\"800K\">800K</option> <option value=\"1000K\">1Mbit</option> </select> </td> <td> <input type=\"text\" id=\"mon_filter\" name=\"mon_filter\" style=\"width: 65px; font-size:100%;\" value=\"00000000\"> </td> <td> <input type=\"text\" id=\"mon_mask\" name=\"mon_mask\" style=\"width: 65px; font-size:100%;\" value=\"FFFFFFFF\"> </td><td>&nbsp;</td> <td> <input id=\"mon_button\" name=\"mon_button\" type=\"button\" onclick=\"mon_control()\" value=\"Start\" style=\"font-size:100%;\"> </td> <td>&nbsp;</td> <td>&nbsp;</td> <td>&nbsp;</td> </tr> </table> <table id=\"table2\"> <tr> <td> <b>ID</b> </td> <td> <b>Type</b> </td> <td> <b>Len</b> </td> <td style=\"width:80%\"> <b>Data</b> </td> <td> <b>Time</b> </td> <td> <b>Count</b> </td> </tr> </table> </div> <div id=\"about_tab\" class=\"tabcontent\"> <table> <tr> <td> <b>Firmware ver:</b> </td> <td> <div id=\"fw_version\"> v1.00 </div> </td> </tr> <tr> <td> <b>Hardware ver:</b> </td> <td> <div id=\"hw_version\"> v2.10 </div> </td> </tr> <tr> <td> <b>Designed By:</b> </td> <td> <div id=\"made_by\"> <a href=\"https://www.meatpi.com/\"> <b>meatpi.com</b> </a> </div> </td> </tr> </table> </div> <div id=\"ret_msg\"> &nbsp; </div> </form> <input id=\"submit_button\" name=\"submit_button\" type=\"button\" onclick=\"postConfig()\" value=\"Submit Changes\" disabled> <script> function openTab(evt, tabName) { var i, tabcontent, tablinks; tabcontent = document.getElementsByClassName(\"tabcontent\"); for (i = 0; i < tabcontent.length; i++) { tabcontent[i].style.display = \"none\"; } tablinks = document.getElementsByClassName(\"tablinks\"); for (i = 0; i < tablinks.length; i++) { tablinks[i].className = tablinks[i].className.replace(\" active\", \"\"); } document.getElementById(tabName).style.display = \"block\"; evt.currentTarget.className += \" active\"; } function sta_enable() {} function submit_enable() { if (document.getElementById(\"wifi_mode\").value == \"AP\") { document.getElementById(\"ssid_value\").disabled = true; document.getElementById(\"pass_value\").disabled = true; } else { document.getElementById(\"ssid_value\").disabled = false; document.getElementById(\"pass_value\").disabled = false; } if (document.getElementById(\"ap_pass_value\").value.length < 8 || document.getElementById(\"ap_pass_value\").value.length > 63 || document.getElementById(\"pass_value\").value.length < 8 || document.getElementById(\"pass_value\").value.length > 63) { document.getElementById(\"ret_msg\").innerHTML = \"AP/station password len, min=0 max=64\"; document.getElementById(\"ret_msg\").style.color = \"red\"; document.getElementById(\"submit_button\").disabled = true; } else if (document.getElementById(\"ssid_value\").value.length < 1 || document.getElementById(\"ssid_value\").value.length > 32) { document.getElementById(\"ret_msg\").innerHTML = \"AP/station ssid len, min=1 max=32\"; document.getElementById(\"ret_msg\").style.color = \"red\"; document.getElementById(\"submit_button\").disabled = true; } else if (document.getElementById(\"tcp_port_value\").value > 65535 || document.getElementById(\"tcp_port_value\").value < 1) { document.getElementById(\"ret_msg\").innerHTML = \"Port value, min=1 max=65535\"; document.getElementById(\"ret_msg\").style.color = \"red\"; document.getElementById(\"submit_button\").disabled = true; } else if (document.getElementById(\"ble_pass_value\").value.length != 6) { document.getElementById(\"ret_msg\").innerHTML = \"Passkey length, min=6 max=6\"; document.getElementById(\"ret_msg\").style.color = \"red\"; document.getElementById(\"submit_button\").disabled = true; } else { document.getElementById(\"submit_button\").disabled = false; document.getElementById(\"ret_msg\").innerHTML = \" \"; } } document.getElementById(\"defaultOpen\").click(); function checkStatus() { const xhttp = new XMLHttpRequest(); xhttp.onload = function() { var obj = JSON.parse(this.responseText); if (obj.wifi_mode == \"APStation\") { document.getElementById(\"wifi_mode_current\").innerHTML = \"AP+Station\"; } else if (obj.wifi_mode == \"AP\") { document.getElementById(\"wifi_mode_current\").innerHTML = \"AP\"; } document.getElementById(\"sta_status\").innerHTML = obj.sta_status; document.getElementById(\"ap_channel_status\").innerHTML = obj.ap_ch; document.getElementById(\"sta_ip\").innerHTML = obj.sta_ip; document.getElementById(\"can_bitrate_status\").innerHTML = obj.can_datarate; if (obj.can_mode == \"normal\") { document.getElementById(\"can_mode_status\").innerHTML = \"Normal\"; } else if (obj.can_mode == \"silent\") { document.getElementById(\"can_mode_status\").innerHTML = \"Silent\"; } if (obj.port_type == \"tcp\") { document.getElementById(\"port_type_status\").innerHTML = \"TCP\"; } else if (obj.port_type == \"udp\") { document.getElementById(\"port_type_status\").innerHTML = \"UDP\"; } document.getElementById(\"port_status\").innerHTML = obj.port; document.getElementById(\"fw_version\").value = obj.fw_version; document.getElementById(\"hw_version\").value = obj.hw_version; document.getElementById(\"protocol\").value = obj.protocol; document.getElementById(\"ret_msg\").innerHTML = \" \"; }; xhttp.open(\"GET\", \"/check_status\"); xhttp.send(); } function postConfig() { var obj = {}; obj[\"wifi_mode\"] = document.getElementById(\"wifi_mode\").value; obj[\"ap_ch\"] = document.getElementById(\"ap_ch_value\").value; obj[\"sta_ssid\"] = document.getElementById(\"ssid_value\").value; obj[\"sta_pass\"] = document.getElementById(\"pass_value\").value; obj[\"can_datarate\"] = document.getElementById(\"can_datarate\").value; obj[\"can_mode\"] = document.getElementById(\"can_mode\").value; obj[\"port_type\"] = document.getElementById(\"port_type\").value; obj[\"port\"] = document.getElementById(\"tcp_port_value\").value; obj[\"ap_pass\"] = document.getElementById(\"ap_pass_value\").value; obj[\"protocol\"] = document.getElementById(\"protocol\").value; obj[\"ble_pass\"] = document.getElementById(\"ble_pass_value\").value; obj[\"ble_status\"] = document.getElementById(\"ble_status\").value; var configJSON = JSON.stringify(obj); const xhttp = new XMLHttpRequest(); xhttp.onload = function() { document.getElementById(\"ret_msg\").innerHTML = this.responseText; document.getElementById(\"ret_msg\").style.color = \"red\"; }; xhttp.open(\"POST\", \"/store_config\"); xhttp.send(configJSON); } function Load() { const xhttp = new XMLHttpRequest(); xhttp.onload = function() { var obj = JSON.parse(this.responseText); if (obj.wifi_mode == \"APStation\") { document.getElementById(\"wifi_mode\").selectedIndex = \"1\"; document.getElementById(\"ssid_value\").disabled = false; document.getElementById(\"pass_value\").disabled = false; } else if (obj.wifi_mode == \"AP\") { document.getElementById(\"wifi_mode\").selectedIndex = \"0\"; document.getElementById(\"ssid_value\").disabled = true; document.getElementById(\"pass_value\").disabled = true; } var ch = parseInt(obj.ap_ch); ch = ch - 1; document.getElementById(\"ap_ch_value\").selectedIndex = ch.toString(); document.getElementById(\"ssid_value\").value = obj.sta_ssid; document.getElementById(\"pass_value\").value = obj.sta_pass; if (obj.can_datarate == \"5K\") { document.getElementById(\"can_datarate\").selectedIndex = \"0\"; } else if (obj.can_datarate == \"10K\") { document.getElementById(\"can_datarate\").selectedIndex = \"1\"; } else if (obj.can_datarate == \"20K\") { document.getElementById(\"can_datarate\").selectedIndex = \"2\"; } else if (obj.can_datarate == \"25K\") { document.getElementById(\"can_datarate\").selectedIndex = \"3\"; } else if (obj.can_datarate == \"50K\") { document.getElementById(\"can_datarate\").selectedIndex = \"4\"; } else if (obj.can_datarate == \"100K\") { document.getElementById(\"can_datarate\").selectedIndex = \"5\"; } else if (obj.can_datarate == \"125K\") { document.getElementById(\"can_datarate\").selectedIndex = \"6\"; } else if (obj.can_datarate == \"250K\") { document.getElementById(\"can_datarate\").selectedIndex = \"7\"; } else if (obj.can_datarate == \"500K\") { document.getElementById(\"can_datarate\").selectedIndex = \"8\"; } else if (obj.can_datarate == \"800K\") { document.getElementById(\"can_datarate\").selectedIndex = \"9\"; } else if (obj.can_datarate == \"1000K\") { document.getElementById(\"can_datarate\").selectedIndex = \"10\"; } if (obj.can_mode == \"normal\") { document.getElementById(\"can_mode\").selectedIndex = \"0\"; } else if (obj.can_mode == \"silent\") { document.getElementById(\"can_mode\").selectedIndex = \"1\"; } if (obj.port_type == \"tcp\") { document.getElementById(\"port_type\").selectedIndex = \"0\"; } else if (obj.port_type == \"udp\") { document.getElementById(\"port_type\").selectedIndex = \"1\"; } if (obj.ble_status == \"enable\") { document.getElementById(\"ble_status\").selectedIndex = \"0\"; } else if (obj.ble_status == \"disable\") { document.getElementById(\"ble_status\").selectedIndex = \"1\"; } document.getElementById(\"protocol\").value = obj.protocol; document.getElementById(\"tcp_port_value\").value = obj.port; document.getElementById(\"ap_pass_value\").value = obj.ap_pass; document.getElementById(\"ble_pass_value\").value = obj.ble_pass; document.getElementById(\"ret_msg\").innerHTML = \" \"; }; checkStatus(); xhttp.open(\"GET\", \"/load_config\"); xhttp.send(); } function monitor_add_line(id, type, len, data, time) { var table = document.getElementById(\"table2\"); var nraw = -1; if (typeof monitor_add_line.msg_time == 'undefined') { monitor_add_line.msg_time = [0]; } for (var r = 1, n = table.rows.length; r < n; r++) { if (table.rows[r].cells[0].innerHTML == id) { nraw = r; break; } } if (nraw != -1) { table.rows[nraw].cells[0].innerHTML = id; table.rows[nraw].cells[1].innerHTML = type; table.rows[nraw].cells[2].innerHTML = len; table.rows[nraw].cells[3].innerHTML = data; table.rows[nraw].cells[4].innerHTML = Date.now() - monitor_add_line.msg_time[nraw]; table.rows[nraw].cells[5].innerHTML = ++table.rows[nraw].cells[5].innerHTML; monitor_add_line.msg_time[nraw] = Date.now(); } else { var row = table.insertRow(1); var cell1 = row.insertCell(0); var cell2 = row.insertCell(1); var cell3 = row.insertCell(2); var cell4 = row.insertCell(3); var cell5 = row.insertCell(4); var cell6 = row.insertCell(5); cell1.innerHTML = id; cell2.innerHTML = type; cell3.innerHTML = len; cell4.innerHTML = data; cell5.innerHTML = 0; cell6.innerHTML = 1; monitor_add_line.msg_time.push(Date.now()); } } var ws = null; var cr = String.fromCharCode(13); function mon_control() {var dr = document.getElementById(\"mon_datarate\").selectedIndex;var url = window.location.href;var url2 = \"http://192.168.31.72/\";console.log(dr);ws_url = \"ws://\"+ url.substr(7, url.length)+\"ws\";console.log(ws_url); if (document.getElementById(\"mon_button\").value == \"Start\") { ws = new WebSocket(ws_url); setTimeout(bindEvents, 1000); ws.addEventListener('open', (event) => {var cmd = \"C\"+cr+\"S\"+dr+cr+\"O\"+cr;console.log('onopen called');ws.send(cmd);window.mon_button_en(0); }); ws.addEventListener('close', (event) => {window.mon_button_en(1);console.log('onclose called'); }); } else { ws_close(); } } function bindEvents() { ws.onmessage = function(evt) { var received_msg = evt.data; if (received_msg[0] == 't') { var len = (received_msg[4] - '0') * 2; var data_str = \"\"; var i; for (i = 0; i < len; i += 2) { data_str += (received_msg.substr(i + 5, 2) + \" \"); } monitor_add_line(received_msg.substr(1, 3)+'h', 'Std', received_msg[4], data_str, 0); }else if (received_msg[0] == 'T') { var len = (received_msg[9] - '0') * 2; var data_str = \"\"; var i; for (i = 0; i < len; i += 2) { data_str += (received_msg.substr(i + 10, 2) + \" \"); } monitor_add_line(received_msg.substr(1, 8)+'h', 'Ext', received_msg[9], data_str, 0); }else if (received_msg[0] == 'r') { var len = (received_msg[4] - '0') * 2; monitor_add_line(received_msg.substr(1, 3)+'h', 'RTR-Std', received_msg[4], 0, 0); }else if (received_msg[0] == 'R') { var len = (received_msg[9] - '0') * 2; monitor_add_line(received_msg.substr(1, 8)+'h', 'RTR-Ext', received_msg[9], 0, 0); } }; } function ws_close() { ws.send(\"C\"+cr); ws.close(); } function mon_button_en(b) {if(b == 1){document.getElementById(\"mon_button\").value = \"Start\";document.getElementById(\"mon_datarate\").disabled = false;document.getElementById(\"mon_filter\").disabled = false;document.getElementById(\"mon_mask\").disabled = false;}else{document.getElementById(\"mon_button\").value = \"Stop\";document.getElementById(\"mon_datarate\").disabled = true;document.getElementById(\"mon_filter\").disabled = true;document.getElementById(\"mon_mask\").disabled = true;} } </script> </body></html>"};
static const char webpage[] = {"<!DOCTYPE html><html> <head> <meta name=\"viewport\" content=\"width=device-width, initial-scale=1\"> <title>WiCAN</title> <style> body { font-family: Arial; } .tab { overflow: hidden; border: 1px solid #24478f; background-color: #c2d1f0; width: 100%; } .tab button { background-color: inherit; float: left; border: none; outline: none; cursor: pointer; padding: 14px 16px; transition: 0.3s; font-size: 17px; } .tab button:hover { background-color: #ddd; } .tab button.active { background-color: #24478f; color: white; } .tabcontent { display: none; padding: 6px 12px; border: 1px solid #24478f; border-top: none; } table, th, td { border-collapse: collapse; border-spacing: 0; width: 350px; text-align: left; padding: 8px; } #table1 { width: 350px; text-align: left; padding: 8px; } #table2 { width: 350px; text-align: left; max-width: 350; font-size: 70%; white-space: nowrap; } #table3 { width: 350px; text-align: left; max-width: 350; font-size: 80%; border: 1px solid; white-space: nowrap; } </style> </head> <body onload=\"Load()\"> <embed src=\"/logo.svg\" style=\"width:165px;height:66px;display: block;\" /> <div class=\"tab\"> <button class=\"tablinks\" onclick=\"openTab(event, 'status_view')\" id=\"defaultOpen\"> <b>Status</b> </button> <button class=\"tablinks\" onclick=\"openTab(event, 'wifi_settings')\"> <b>Settings</b> </button> <button class=\"tablinks\" onclick=\"openTab(event, 'monitor')\"> <b>Monitor</b> </button> <button class=\"tablinks\" onclick=\"openTab(event, 'about_tab')\"> <b>About</b> </button> </div> <div id=\"status_view\" class=\"tabcontent\"> <table> <tr> <td> <b>WiFi Mode:</b> </td> <td> <div id=\"wifi_mode_current\"> AP&nbsp; </div> </td> </tr> <tr> <td> <b>AP Channel:</b> </td> <td> <div id=\"ap_channel_status\"> 6&nbsp; </div> </td> </tr> <tr> <td> <b>WiFi Station:</b> </td> <td> <div id=\"sta_status\"> Not Connected&nbsp; </div> </td> </tr> <tr> <td> <b>Station IP:</b> </td> <td> <div id=\"sta_ip\"> 192.168.3.1&nbsp; </div> </td> </tr> <tr> <td> <b>CAN Bitrate:</b> </td> <td> <div id=\"can_bitrate_status\"> 500K&nbsp; </div> </td> </tr> <tr> <td> <b>CAN Mode:</b> </td> <td> <div id=\"can_mode_status\"> Silent&nbsp; </div> </td> </tr> <tr> <td> <b>Port Type:</b> </td> <td> <div id=\"port_type_status\"> TCP&nbsp; </div> </td> </tr> <tr> <td> <b>TCP/UDP Port:</b> </td> <td> <div id=\"port_status\"> 3333&nbsp; </div> </td> </tr> <tr> <td> <input id=\"check_status_button\" name=\"check_status_button\" type=\"button\" onclick=\"checkStatus()\" value=\"Check status\"> </td> <td>&nbsp;</td> </tr> </table> </div> <form id=\"configForm\" name=\"configForm\" action=\"/action_page\" onchange=\"submit_enable();\" onfocus=\"this.selectedIndex = -1;\"> <div id=\"wifi_settings\" class=\"tabcontent\"> <table> <tr> <td> <b> <u>AP Config:</u> </b> </td> <td>&nbsp;</td> </tr> <tr> <td> <label for=\"wifi_mode\"> <b>Mode:</b> </label> </td> <td> <select name=\"wifi_mode\" style=\"width: 93px\" id=\"wifi_mode\"> <option value=\"AP\">Ap</option> <option value=\"APStation\">AP+Station</option> </select> </td> </tr> <tr> <td> <b>AP Channel:</b> </td> <td> <select name=\"ap_ch_value\" style=\"width: 93px\" id=\"ap_ch_value\"> <option value=\"1\">1</option> <option value=\"2\">2</option> <option value=\"3\">3</option> <option value=\"4\">4</option> <option value=\"5\">5</option> <option value=\"6\">6</option> <option value=\"7\">7</option> <option value=\"8\">8</option> <option value=\"9\">9</option> <option value=\"10\">10</option> <option value=\"11\">11</option> <option value=\"12\">12</option> <option value=\"13\">13</option> <option value=\"14\">14</option> </select> </td> </tr> <tr> <td> <label for=\"ap_pass_value\"> <b>AP Password:</b> </label> </td> <td> <input type=\"text\" id=\"ap_pass_value\" name=\"ap_pass_value\" value=\"Testpass\"> </td> </tr> <tr> <td>&nbsp;</td> <td>&nbsp;</td> </tr> <tr> <td> <b> <u>Station Config:</u> </b> </td> <td>&nbsp;</td> </tr> <tr> <td> <label for=\"ssid_value\"> <b>SSID:</b> </label> </td> <td> <input type=\"text\" id=\"ssid_value\" name=\"ssid_value\" value=\"MeatPi\" disabled> </td> </tr> <tr> <td> <label for=\"pass_value\"> <b>Password:</b> </label> </td> <td> <input type=\"text\" id=\"pass_value\" name=\"pass_value\" value=\"TomatoSauce\" disabled> </td> </tr> <tr> <td>&nbsp;</td> <td>&nbsp;</td> </tr> <tr> <td> <b> <u>CAN:</u> </b> </td> <td>&nbsp;</td> </tr> <tr> <td> <label for=\"can_datarate\"> <b>CAN Bitrate:</b> </label> </td> <td> <select name=\"can_datarate\" style=\"width: 93px\" id=\"can_datarate\"> <option value=\"5K\">5K</option> <option value=\"10K\">10K</option> <option value=\"20K\">20K</option> <option value=\"25K\">25K</option> <option value=\"50K\">50K</option> <option value=\"100K\">100K</option> <option value=\"125K\">125K</option> <option value=\"250K\">250K</option> <option value=\"500K\">500K</option> <option value=\"800K\">800K</option> <option value=\"1000K\">1000K</option> </select> </td> </tr> <tr> <td> <label for=\"can_mode\"> <b>CAN Mode:</b> </label> </td> <td> <select name=\"can_mode\" style=\"width: 93px\" id=\"can_mode\"> <option value=\"normal\" selected=\"selected\">Normal</option> <option value=\"silent\">Silent</option> </select> </td> </tr> <tr> <td> <label for=\"port_type\"> <b>Port Type:</b> </label> </td> <td> <select name=\"port_type\" style=\"width: 93px\" id=\"port_type\"> <option value=\"tcp\">TCP</option> <option value=\"udp\">UDP</option> </select> </td> </tr> <tr> <td> <label for=\"tcp_port_value\"> <b>TCP/UDP Port:</b> </label> </td> <td> <input type=\"number\" id=\"tcp_port_value\" name=\"tcp_port_value\" value=\"3333\" min=\"1\" max=\"65535\"> </td> </tr> <tr> <td> <label for=\"protocol\"> <b>Protocol:</b> </label> </td> <td> <select name=\"protocol\" style=\"width: 93px\" id=\"protocol\"> <option value=\"realdash66\">realdash66</option> <option value=\"slcan\">slcan</option><option value=\"savvycan\">savvyCAN</option> </select> </td> </tr> <tr> <td>&nbsp;</td> <td>&nbsp;</td> </tr> <tr> <td> <b> <u>BLE:</u> </b> </td> <td>&nbsp;</td> </tr> <tr> <td> <label for=\"ble_pass_value\"> <b>Passkey:</b> </label> </td> <td> <input type=\"number\" id=\"ble_pass_value\" name=\"ble_pass_value\" value=\"000000\" min=\"0\" max=\"999999\"> </td> </tr> <tr> <td> <label for=\"ble_status\"> <b>BLE Status:</b> </label> </td> <td> <select name=\"ble_status\" style=\"width: 93px\" id=\"ble_status\"> <option value=\"enable\">Enable</option> <option value=\"disable\">Disable</option> </select> </td> </tr> <tr> <td> <div id=\"tcp_txt\"> &nbsp; </div> </td> <td>&nbsp;</td> </tr> </table> <div id=\"note\"> <u> <b>Note:</b> If you forget the AP password, connect usb cable to recover </u> </div> </div> </form> <div id=\"monitor\" class=\"tabcontent\"> <table id=\"table3\"> <tr> <td> <b>Bitrate</b> </td> <td> <b>Filter</b> </td> <td> <b>Mask</b> </td> <td>&nbsp;</td> <td>&nbsp;</td> <td>&nbsp;</td> <td>&nbsp;</td> <td>&nbsp;</td> </tr> <tr> <td> <select name=\"mon_datarate\" id=\"mon_datarate\" style=\"font-size:100%;\"> <option value=\"10K\">10K</option> <option value=\"20K\">20K</option> <option value=\"50K\">50K</option> <option value=\"100K\">100K</option> <option value=\"125K\">125K</option> <option value=\"250K\">250K</option> <option value=\"500K\" selected=\"selected\">500K</option> <option value=\"800K\">800K</option> <option value=\"1000K\">1Mbit</option> </select> </td> <td> <input type=\"text\" id=\"mon_filter\" name=\"mon_filter\" style=\"width: 65px; font-size:100%;\" value=\"00000000\"> </td> <td> <input type=\"text\" id=\"mon_mask\" name=\"mon_mask\" style=\"width: 65px; font-size:100%;\" value=\"FFFFFFFF\"> </td> <td>&nbsp;</td> <td> <input id=\"mon_button\" name=\"mon_button\" type=\"button\" onclick=\"mon_control()\" value=\"Start\" style=\"font-size:100%;\"> </td> <td>&nbsp;</td> <td>&nbsp;</td> <td>&nbsp;</td> </tr> </table> <table id=\"table2\"> <tr> <td> <b>ID</b> </td> <td> <b>Type</b> </td> <td> <b>Len</b> </td> <td style=\"width:80%\"> <b>Data</b> </td> <td> <b>Time</b> </td> <td> <b>Count</b> </td> </tr> </table> </div> <div id=\"about_tab\" class=\"tabcontent\"> <table> <tr> <td> <b>Firmware ver:</b> </td> <td> <div id=\"fw_version\"> v1.00 </div> </td> </tr> <tr> <td> <b>Hardware ver:</b> </td> <td> <div id=\"hw_version\"> v2.10 </div> </td> </tr> <tr> <td> <b>Designed By:</b> </td> <td> <div id=\"made_by\"> <a href=\"https://www.meatpi.com/\"> <b>meatpi.com</b> </a> </div> </td> </tr> <tr> <form action=\"/upload/ota.bin\" method=\"post\" enctype=\"multipart/form-data\"> <td> <!--Content will go inside here.--> <input name=\"file1\" type=\"file\"> </td> <td> <input type=\"submit\" value=\"Update\"> </td> </form> </tr> </table> </div> <div id=\"ret_msg\"> &nbsp; </div> <input id=\"submit_button\" name=\"submit_button\" type=\"button\" onclick=\"postConfig()\" value=\"Submit Changes\" disabled> <script> function openTab(evt, tabName) { var i, tabcontent, tablinks; tabcontent = document.getElementsByClassName(\"tabcontent\"); for (i = 0; i < tabcontent.length; i++) { tabcontent[i].style.display = \"none\"; } tablinks = document.getElementsByClassName(\"tablinks\"); for (i = 0; i < tablinks.length; i++) { tablinks[i].className = tablinks[i].className.replace(\" active\", \"\"); } document.getElementById(tabName).style.display = \"block\"; evt.currentTarget.className += \" active\"; } function sta_enable() {} function submit_enable() { if (document.getElementById(\"wifi_mode\").value == \"AP\") { document.getElementById(\"ssid_value\").disabled = true; document.getElementById(\"pass_value\").disabled = true; } else { document.getElementById(\"ssid_value\").disabled = false; document.getElementById(\"pass_value\").disabled = false; } if (document.getElementById(\"ap_pass_value\").value.length < 8 || document.getElementById(\"ap_pass_value\").value.length > 63 || document.getElementById(\"pass_value\").value.length < 8 || document.getElementById(\"pass_value\").value.length > 63) { document.getElementById(\"ret_msg\").innerHTML = \"AP/station password len, min=0 max=64\"; document.getElementById(\"ret_msg\").style.color = \"red\"; document.getElementById(\"submit_button\").disabled = true; } else if (document.getElementById(\"ssid_value\").value.length < 1 || document.getElementById(\"ssid_value\").value.length > 32) { document.getElementById(\"ret_msg\").innerHTML = \"AP/station ssid len, min=1 max=32\"; document.getElementById(\"ret_msg\").style.color = \"red\"; document.getElementById(\"submit_button\").disabled = true; } else if (document.getElementById(\"tcp_port_value\").value > 65535 || document.getElementById(\"tcp_port_value\").value < 1) { document.getElementById(\"ret_msg\").innerHTML = \"Port value, min=1 max=65535\"; document.getElementById(\"ret_msg\").style.color = \"red\"; document.getElementById(\"submit_button\").disabled = true; } else if (document.getElementById(\"ble_pass_value\").value.length != 6) { document.getElementById(\"ret_msg\").innerHTML = \"Passkey length, min=6 max=6\"; document.getElementById(\"ret_msg\").style.color = \"red\"; document.getElementById(\"submit_button\").disabled = true; } else { document.getElementById(\"submit_button\").disabled = false; document.getElementById(\"ret_msg\").innerHTML = \" \"; }if( document.getElementById(\"protocol\").value == \"savvycan\"){ document.getElementById(\"tcp_port_value\").value = \"23\"; document.getElementById(\"tcp_port_value\").disabled = true; document.getElementById(\"port_type\").selectedIndex = \"0\"; document.getElementById(\"port_type\").disabled = true;} else{ document.getElementById(\"tcp_port_value\").value = \"3333\"; document.getElementById(\"tcp_port_value\").disabled = false; document.getElementById(\"port_type\").selectedIndex = \"0\"; document.getElementById(\"port_type\").disabled = false;} } document.getElementById(\"defaultOpen\").click(); function checkStatus() { const xhttp = new XMLHttpRequest(); xhttp.onload = function() { var obj = JSON.parse(this.responseText); if (obj.wifi_mode == \"APStation\") { document.getElementById(\"wifi_mode_current\").innerHTML = \"AP+Station\"; } else if (obj.wifi_mode == \"AP\") { document.getElementById(\"wifi_mode_current\").innerHTML = \"AP\"; } document.getElementById(\"sta_status\").innerHTML = obj.sta_status; document.getElementById(\"ap_channel_status\").innerHTML = obj.ap_ch; document.getElementById(\"sta_ip\").innerHTML = obj.sta_ip; document.getElementById(\"can_bitrate_status\").innerHTML = obj.can_datarate; if (obj.can_mode == \"normal\") { document.getElementById(\"can_mode_status\").innerHTML = \"Normal\"; } else if (obj.can_mode == \"silent\") { document.getElementById(\"can_mode_status\").innerHTML = \"Silent\"; } if (obj.port_type == \"tcp\") { document.getElementById(\"port_type_status\").innerHTML = \"TCP\"; } else if (obj.port_type == \"udp\") { document.getElementById(\"port_type_status\").innerHTML = \"UDP\"; } document.getElementById(\"port_status\").innerHTML = obj.port; document.getElementById(\"fw_version\").innerHTML = obj.fw_version; document.getElementById(\"hw_version\").innerHTML = obj.hw_version; document.getElementById(\"protocol\").value = obj.protocol; document.getElementById(\"ret_msg\").innerHTML = \" \"; }; xhttp.open(\"GET\", \"/check_status\"); xhttp.send(); } function postConfig() { var obj = {}; obj[\"wifi_mode\"] = document.getElementById(\"wifi_mode\").value; obj[\"ap_ch\"] = document.getElementById(\"ap_ch_value\").value; obj[\"sta_ssid\"] = document.getElementById(\"ssid_value\").value; obj[\"sta_pass\"] = document.getElementById(\"pass_value\").value; obj[\"can_datarate\"] = document.getElementById(\"can_datarate\").value; obj[\"can_mode\"] = document.getElementById(\"can_mode\").value; obj[\"port_type\"] = document.getElementById(\"port_type\").value; obj[\"port\"] = document.getElementById(\"tcp_port_value\").value; obj[\"ap_pass\"] = document.getElementById(\"ap_pass_value\").value; obj[\"protocol\"] = document.getElementById(\"protocol\").value; obj[\"ble_pass\"] = document.getElementById(\"ble_pass_value\").value; obj[\"ble_status\"] = document.getElementById(\"ble_status\").value; var configJSON = JSON.stringify(obj); const xhttp = new XMLHttpRequest(); xhttp.onload = function() { document.getElementById(\"ret_msg\").innerHTML = this.responseText; document.getElementById(\"ret_msg\").style.color = \"red\"; }; xhttp.open(\"POST\", \"/store_config\"); xhttp.send(configJSON); } function Load() { const xhttp = new XMLHttpRequest(); xhttp.onload = function() { var obj = JSON.parse(this.responseText); if (obj.wifi_mode == \"APStation\") { document.getElementById(\"wifi_mode\").selectedIndex = \"1\"; document.getElementById(\"ssid_value\").disabled = false; document.getElementById(\"pass_value\").disabled = false; } else if (obj.wifi_mode == \"AP\") { document.getElementById(\"wifi_mode\").selectedIndex = \"0\"; document.getElementById(\"ssid_value\").disabled = true; document.getElementById(\"pass_value\").disabled = true; } var ch = parseInt(obj.ap_ch); ch = ch - 1; document.getElementById(\"ap_ch_value\").selectedIndex = ch.toString(); document.getElementById(\"ssid_value\").value = obj.sta_ssid; document.getElementById(\"pass_value\").value = obj.sta_pass; if (obj.can_datarate == \"5K\") { document.getElementById(\"can_datarate\").selectedIndex = \"0\"; } else if (obj.can_datarate == \"10K\") { document.getElementById(\"can_datarate\").selectedIndex = \"1\"; } else if (obj.can_datarate == \"20K\") { document.getElementById(\"can_datarate\").selectedIndex = \"2\"; } else if (obj.can_datarate == \"25K\") { document.getElementById(\"can_datarate\").selectedIndex = \"3\"; } else if (obj.can_datarate == \"50K\") { document.getElementById(\"can_datarate\").selectedIndex = \"4\"; } else if (obj.can_datarate == \"100K\") { document.getElementById(\"can_datarate\").selectedIndex = \"5\"; } else if (obj.can_datarate == \"125K\") { document.getElementById(\"can_datarate\").selectedIndex = \"6\"; } else if (obj.can_datarate == \"250K\") { document.getElementById(\"can_datarate\").selectedIndex = \"7\"; } else if (obj.can_datarate == \"500K\") { document.getElementById(\"can_datarate\").selectedIndex = \"8\"; } else if (obj.can_datarate == \"800K\") { document.getElementById(\"can_datarate\").selectedIndex = \"9\"; } else if (obj.can_datarate == \"1000K\") { document.getElementById(\"can_datarate\").selectedIndex = \"10\"; } if (obj.can_mode == \"normal\") { document.getElementById(\"can_mode\").selectedIndex = \"0\"; } else if (obj.can_mode == \"silent\") { document.getElementById(\"can_mode\").selectedIndex = \"1\"; } if (obj.port_type == \"tcp\") { document.getElementById(\"port_type\").selectedIndex = \"0\"; } else if (obj.port_type == \"udp\") { document.getElementById(\"port_type\").selectedIndex = \"1\"; } if (obj.ble_status == \"enable\") { document.getElementById(\"ble_status\").selectedIndex = \"0\"; } else if (obj.ble_status == \"disable\") { document.getElementById(\"ble_status\").selectedIndex = \"1\"; } document.getElementById(\"protocol\").value = obj.protocol; document.getElementById(\"tcp_port_value\").value = obj.port; document.getElementById(\"ap_pass_value\").value = obj.ap_pass; document.getElementById(\"ble_pass_value\").value = obj.ble_pass; if( document.getElementById(\"protocol\").value == \"savvycan\"){ document.getElementById(\"tcp_port_value\").value = \"23\"; document.getElementById(\"tcp_port_value\").disabled = true; document.getElementById(\"port_type\").selectedIndex = \"0\"; document.getElementById(\"port_type\").disabled = true; } document.getElementById(\"ret_msg\").innerHTML = \" \"; }; checkStatus(); xhttp.open(\"GET\", \"/load_config\"); xhttp.send(); } function monitor_add_line(id, type, len, data, time) { var table = document.getElementById(\"table2\"); var nraw = -1; if (typeof monitor_add_line.msg_time == 'undefined') { monitor_add_line.msg_time = [0]; } for (var r = 1, n = table.rows.length; r < n; r++) { if (table.rows[r].cells[0].innerHTML == id) { nraw = r; break; } } if (nraw != -1) { table.rows[nraw].cells[0].innerHTML = id; table.rows[nraw].cells[1].innerHTML = type; table.rows[nraw].cells[2].innerHTML = len; table.rows[nraw].cells[3].innerHTML = data; table.rows[nraw].cells[4].innerHTML = Date.now() - monitor_add_line.msg_time[nraw]; table.rows[nraw].cells[5].innerHTML = ++table.rows[nraw].cells[5].innerHTML; monitor_add_line.msg_time[nraw] = Date.now(); } else { var row = table.insertRow(1); var cell1 = row.insertCell(0); var cell2 = row.insertCell(1); var cell3 = row.insertCell(2); var cell4 = row.insertCell(3); var cell5 = row.insertCell(4); var cell6 = row.insertCell(5); cell1.innerHTML = id; cell2.innerHTML = type; cell3.innerHTML = len; cell4.innerHTML = data; cell5.innerHTML = 0; cell6.innerHTML = 1; monitor_add_line.msg_time.push(Date.now()); } } var ws = null; var cr = String.fromCharCode(13); function mon_control() { var dr = document.getElementById(\"mon_datarate\").selectedIndex; var url = window.location.href; var url2 = \"http://192.168.31.72/\"; console.log(dr); ws_url = \"ws://\" + url.substr(7, url.length) + \"ws\"; console.log(ws_url); if (document.getElementById(\"mon_button\").value == \"Start\") { ws = new WebSocket(ws_url); setTimeout(bindEvents, 1000); ws.addEventListener('open', (event) => { var cmd = \"C\" + cr + \"S\" + dr + cr + \"O\" + cr; console.log('onopen called'); ws.send(cmd); window.mon_button_en(0); }); ws.addEventListener('close', (event) => { window.mon_button_en(1); console.log('onclose called'); }); } else { ws_close(); } } function bindEvents() { ws.onmessage = function(evt) { var received_msg = evt.data; if (received_msg[0] == 't') { var len = (received_msg[4] - '0') * 2; var data_str = \"\"; var i; for (i = 0; i < len; i += 2) { data_str += (received_msg.substr(i + 5, 2) + \" \"); } monitor_add_line(received_msg.substr(1, 3) + 'h', 'Std', received_msg[4], data_str, 0); } else if (received_msg[0] == 'T') { var len = (received_msg[9] - '0') * 2; var data_str = \"\"; var i; for (i = 0; i < len; i += 2) { data_str += (received_msg.substr(i + 10, 2) + \" \"); } monitor_add_line(received_msg.substr(1, 8) + 'h', 'Ext', received_msg[9], data_str, 0); } else if (received_msg[0] == 'r') { var len = (received_msg[4] - '0') * 2; monitor_add_line(received_msg.substr(1, 3) + 'h', 'RTR-Std', received_msg[4], 0, 0); } else if (received_msg[0] == 'R') { var len = (received_msg[9] - '0') * 2; monitor_add_line(received_msg.substr(1, 8) + 'h', 'RTR-Ext', received_msg[9], 0, 0); } }; } function ws_close() { ws.send(\"C\" + cr); ws.close(); } function mon_button_en(b) { if (b == 1) { document.getElementById(\"mon_button\").value = \"Start\"; document.getElementById(\"mon_datarate\").disabled = false; document.getElementById(\"mon_filter\").disabled = false; document.getElementById(\"mon_mask\").disabled = false; } else { document.getElementById(\"mon_button\").value = \"Stop\"; document.getElementById(\"mon_datarate\").disabled = true; document.getElementById(\"mon_filter\").disabled = true; document.getElementById(\"mon_mask\").disabled = true; } } </script> </body></html>"};
const char device_config_default[] = "{\"wifi_mode\":\"AP\",\"ap_ch\":\"6\",\"sta_ssid\":\"MeatPi\",\"sta_pass\":\"TomatoSauce\",\"can_datarate\":\"500K\",\"can_mode\":\"normal\",\"port_type\":\"tcp\",\"port\":\"3333\", \"ap_pass\":\"@meatpi#\", \"protocol\":\"slcan\", \"ble_pass\":\"123456\", \"ble_status\":\"disable\"}";
...
static esp_err_t check_status_handler(httpd_req_t *req)
{
	...
	cJSON_AddStringToObject(root, "hw_version", HW_VERSION);
...
static esp_err_t upload_post_handler(httpd_req_t *req)
{
	...
	char *ret = 0;
	static char *boundary_start = 0;
	static char *boundary_end = 0;
	uint8_t count = 0;
...
//{
//	char ch = 0;
////	ESP_LOGI(TAG, "Opening ble file");
//	FILE* f = fopen("/spiffs/ble.json", "r+");
//	if (f == NULL)
//	{
//		ESP_LOGI(TAG, "ble file does not exist, load default");
//		f = fopen("/spiffs/ble.json", "w");
//
////		fprintf(f, device_config_default);
//		fwrite(&b, 1, 1, f);
//		fclose(f);
...
//	{
//		ESP_LOGI(TAG, "ble file does not exist, load default");
//		config_server_set_ble_tempfn(0);
//		return 0;
//	}
//	fseek(f, 0, SEEK_SET);
//	fread(&ch, 1, 1, f);
//	ESP_LOGW(TAG, "ch:%d", ch);
//	fclose(f);
//
//	return ch;
//}
