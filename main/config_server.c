...
const char device_config_default[] = "{\"wifi_mode\":\"AP\",\"ap_ch\":\"6\",\"sta_ssid\":\"MeatPi\",\"sta_pass\":\"TomatoSauce\",\"can_datarate\":\"500K\",\"can_mode\":\"normal\",\"port_type\":\"tcp\",\"port\":\"3333\", \"ap_pass\":\"@meatpi#\", \"protocol\":\"socketcan\", \"ble_pass\":\"123456\", \"ble_status\":\"disable\"}";
...
{
	if(strcmp(device_config.protocol, "socketcan") == 0)
	{
		return SOCKETCAN;
	}
...
static esp_err_t check_status_handler(httpd_req_t *req)
{
	...
	cJSON_AddStringToObject(root, "sta_status", (config_server_get_wifi_connected()?"Connected":"Not Connected"));
...
{
	static xTCP_Buffer ucTX_Buffer;
	httpd_ws_frame_t ws_pkt;
