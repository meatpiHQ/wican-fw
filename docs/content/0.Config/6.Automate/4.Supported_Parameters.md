...
| `ENGINE_OIL_PRES` | Engine Oil Pressure | unit: KPa, class: pressure, state_class: measurement |
| `ENGINE_OIL_TEMP` | Engine Oil Temperature | unit: °C, class: temperature, state_class: measurement |
...
| `PCM_Transmission_Temp` | Transmission Temperature | unit: °C, class: temperature, state_class: measurement, min: -40, max: 200 |
| `PCM_Wastegate` | Wastegate Position | unit: %, class: percentage, min: 0, max: 100 |
| `POWER_MAX` | Max power used | unit: kW, class: power |
| `RANGE` | Current Range | unit: km, class: distance, state_class: measurement |
| `READY` | Is the car ready? | unit: none, class: none, type: binary_sensor |
| `REGEN_MAX` | Max regen achieved | unit: kW, class: power |
| `SOC` | State Of Charge | unit: %, class: battery, state_class: measurement, min: 0, max: 100 |
