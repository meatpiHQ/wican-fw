...
2. **Flash the Firmware onto the ESP32 Board:**
   ...
   - Install the latest version of the **ESP-IDF** extension:
     ...
     - After installation, click **Configure Extension**.
       ...
       ![Configure ESP-IDF Extension](https://github.com/user-attachments/assets/34e827e9-0991-418e-8ab7-96eecda7a1d2)

     - Select the **Express** installation option.

       ![Select Express Installation](https://github.com/user-attachments/assets/31df3fa8-c21d-4de2-90e4-3f728e8c3095)

     - Enable the **Show all ESP-IDF tags** option, choose **v5.1 (release version)** from the dropdown menu, and click **Install**.

       ![Enable ESP-IDF Tags](https://github.com/user-attachments/assets/cbc6f50c-2575-4ef4-b49a-6cea8814b340)
